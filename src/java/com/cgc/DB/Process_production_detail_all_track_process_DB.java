 ...
 * @author
 */
public class Process_production_detail_all_track_process_DB {
    ...
    public void generater_transaction_process(String job_id, String user_login,Timestamp ts) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (rs.getString("job_type_id").equals("002") || rs.getString("job_type_id").equals("008")|| rs.getString("job_type_id").equals("006")) {
                    ...
                    dataBean.setWeight_string(rs.getString("weight"));
                    dataBean.setTotal_weight(rs.getDouble("weight"));
    ...
    private void insert_product(DataBeanD_product_receive_process_track_result dataBean, Connection con, PreparedStatement p) throws Exception {
        String SQL_Insert = "";
        try {

            SQL_Insert = "insert into d_product_receive_process_track_result"
                    //+ "(job_id,machine,doc_type,size,iodine,month,year,weight_string,total_weight) "
                    + "(job_id,machine,doc_type,size,month,year,weight_string,total_weight,create_by,create_date) "
                    + "values(?,?,?,?,?,?,?,?,?,?)";
            ...
            p.setString(5, dataBean.getMonth());
            p.setString(6, dataBean.getYear());
            p.setString(7, dataBean.getWeight_string());
            p.setDouble(8, dataBean.getTotal_weight());
    ...
    private void update_product(DataBeanD_product_receive_process_track_result dataBean, Connection con, PreparedStatement p) throws Exception {
        String SQL_Update = "";
        String weight_string = "";
        try {
...
*/        
            ...
            //System.out.println("weight_string = " + weight_string);
