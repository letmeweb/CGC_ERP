 ...
 * @author Man
 */
public class D_carbon_out_analysis_detailDAO_New {
    ...
    public void insert(DataBeanD_carbon_out_analysis_detail DataBean) throws Exception {
        ...
        try {
            ...
            i += 1;
            p.setString(i, DataBean.getC_type1());
            i += 1;
            p.setString(i, DataBean.getBu1());
            i += 1;
            p.setString(i, DataBean.getAvg1());
            i += 1;
            p.setString(i, DataBean.getC_type2());
            i += 1;
            p.setString(i, DataBean.getBu2());
            i += 1;
            p.setString(i, DataBean.getAvg2());
            i += 1;
            p.setString(i, DataBean.getC_type3());
            i += 1;
            p.setString(i, DataBean.getBu3());
            i += 1;
            p.setString(i, DataBean.getAvg3());
            i += 1;
    ...
    public String ShowDetail(String doc_id) throws Exception {
        ...
        try {
            if (objuti.numRowdatabase(SQL) == 0) {
                ...
                while (rs.next()) {
                    str_return.append("<div class='row'>");                    
                    str_return.append("<label class='control-label col-md-1 columnlabel1'><a href=\"#\"  class='link_data_transparent' onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",username,doc_id,tdate1,tname1,ttime1,tdate2,tname2,ttime2,tdate3,tname3,ttime3',''))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a></label>");
                    //str_return.append("<div class='col-md-1'><font color='blue'><input type='text' class='inputs1' name='c_type1_" + rs.getString("line_no") + "' id='c_type1_" + rs.getString("line_no") + "' size='7' value= '" + rs.getString("c_type1") + "' readonly='true' onclick=\"openBrWindow('vmrawmat&textinput=c_type1_\"" + rs.getString("line_no") + "\"', 0, 'Search_Detail.jsp')\" /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='blue'><input type='text' class='inputs1' name='c_type1_" + rs.getString("line_no") + "' id='c_type1_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("c_type1") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='blue'><input type='text' class='inputs1' name='bu1_" + rs.getString("line_no") + "' id='bu1_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("bu1") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='blue'><input type='text' class='inputs1' name='avg1_" + rs.getString("line_no") + "' id='avg1_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("avg1") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='green'><input type='text' class='inputs1' name='c_type2_" + rs.getString("line_no") + "' id='c_type2_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("c_type2") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='green'><input type='text' class='inputs1' name='bu2_" + rs.getString("line_no") + "' id='bu2_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("bu2") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='green'><input type='text' class='inputs1' name='avg2_" + rs.getString("line_no") + "' id='avg2_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("avg2") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='red'><input type='text' class='inputs1' name='c_type3_" + rs.getString("line_no") + "' id='c_type3_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("c_type3") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='red'><input type='text' class='inputs1' name='bu3_" + rs.getString("line_no") + "' id='bu3_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("bu3") + " /></font></div>");
                    str_return.append("<div class='col-md-1'><font color='red'><input type='text' class='inputs1' name='avg3_" + rs.getString("line_no") + "' id='avg3_" + rs.getString("line_no") + "' size='7' value= " + rs.getString("avg3") + " /></font></div>");
                    str_return.append("</div>");
                }
            }        
        } catch (Exception e) {
            e.printStackTrace(System.out);
