 ...
 * @author
 */
public class Process_production_detail_withdraw_edit_track_process_DB {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (!struti.SubLastString(rs.getString("job_type_desc"), 1).equals("1") || rs.getString("job_type_id").equals("008")) {
                    ...
                    dataBean.setDoc_type("2");

                    dataBean.setBy(user_login);
                    dataBean.setDate(ts);

                    dataBean.setD_1(rs.getString("doc_date").substring(0, 2).equals("01") ? rs.getDouble("qty") : 0);
                    dataBean.setD_2(rs.getString("doc_date").substring(0, 2).equals("02") ? rs.getDouble("qty") : 0);
                    dataBean.setD_3(rs.getString("doc_date").substring(0, 2).equals("03") ? rs.getDouble("qty") : 0);
                    dataBean.setD_4(rs.getString("doc_date").substring(0, 2).equals("04") ? rs.getDouble("qty") : 0);
                    dataBean.setD_5(rs.getString("doc_date").substring(0, 2).equals("05") ? rs.getDouble("qty") : 0);
                    dataBean.setD_6(rs.getString("doc_date").substring(0, 2).equals("06") ? rs.getDouble("qty") : 0);
                    dataBean.setD_7(rs.getString("doc_date").substring(0, 2).equals("07") ? rs.getDouble("qty") : 0);
                    dataBean.setD_8(rs.getString("doc_date").substring(0, 2).equals("08") ? rs.getDouble("qty") : 0);
                    dataBean.setD_9(rs.getString("doc_date").substring(0, 2).equals("09") ? rs.getDouble("qty") : 0);
                    dataBean.setD_10(rs.getString("doc_date").substring(0, 2).equals("10") ? rs.getDouble("qty") : 0);
                    dataBean.setD_11(rs.getString("doc_date").substring(0, 2).equals("11") ? rs.getDouble("qty") : 0);
                    dataBean.setD_12(rs.getString("doc_date").substring(0, 2).equals("12") ? rs.getDouble("qty") : 0);
                    dataBean.setD_13(rs.getString("doc_date").substring(0, 2).equals("13") ? rs.getDouble("qty") : 0);
                    dataBean.setD_14(rs.getString("doc_date").substring(0, 2).equals("14") ? rs.getDouble("qty") : 0);
                    dataBean.setD_15(rs.getString("doc_date").substring(0, 2).equals("15") ? rs.getDouble("qty") : 0);
                    dataBean.setD_16(rs.getString("doc_date").substring(0, 2).equals("16") ? rs.getDouble("qty") : 0);
                    dataBean.setD_17(rs.getString("doc_date").substring(0, 2).equals("17") ? rs.getDouble("qty") : 0);
                    dataBean.setD_18(rs.getString("doc_date").substring(0, 2).equals("18") ? rs.getDouble("qty") : 0);
                    dataBean.setD_19(rs.getString("doc_date").substring(0, 2).equals("19") ? rs.getDouble("qty") : 0);
                    dataBean.setD_20(rs.getString("doc_date").substring(0, 2).equals("20") ? rs.getDouble("qty") : 0);
                    dataBean.setD_21(rs.getString("doc_date").substring(0, 2).equals("21") ? rs.getDouble("qty") : 0);
                    dataBean.setD_22(rs.getString("doc_date").substring(0, 2).equals("22") ? rs.getDouble("qty") : 0);
                    dataBean.setD_23(rs.getString("doc_date").substring(0, 2).equals("23") ? rs.getDouble("qty") : 0);
                    dataBean.setD_24(rs.getString("doc_date").substring(0, 2).equals("24") ? rs.getDouble("qty") : 0);
                    dataBean.setD_25(rs.getString("doc_date").substring(0, 2).equals("25") ? rs.getDouble("qty") : 0);
                    dataBean.setD_26(rs.getString("doc_date").substring(0, 2).equals("26") ? rs.getDouble("qty") : 0);
                    dataBean.setD_27(rs.getString("doc_date").substring(0, 2).equals("27") ? rs.getDouble("qty") : 0);
                    dataBean.setD_28(rs.getString("doc_date").substring(0, 2).equals("28") ? rs.getDouble("qty") : 0);
                    dataBean.setD_29(rs.getString("doc_date").substring(0, 2).equals("29") ? rs.getDouble("qty") : 0);
                    dataBean.setD_30(rs.getString("doc_date").substring(0, 2).equals("30") ? rs.getDouble("qty") : 0);
                    dataBean.setD_31(rs.getString("doc_date").substring(0, 2).equals("31") ? rs.getDouble("qty") : 0);

                    //System.out.println("weight" + rs.getDouble("qty"));
                    //total_weight = total_weight + rs.getDouble("qty");
...
//                System.out.println(rs.getDouble("sum_d_" + 10));
            ...
            //System.out.println("Out Loop = " + 7 + " value " + day_weight[7] + " | " + day_sum[7]);
