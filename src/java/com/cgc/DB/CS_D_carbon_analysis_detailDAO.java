 ...
 * @author Pongsak
 */
public class CS_D_carbon_analysis_detailDAO {
    ...
    public void insert(DataBeand_carbon_send_product_detail DataBean) throws Exception {
        ...
        int i = 1;
        try {
            p = con.prepareStatement("insert into d_carbon_analysis_all_detail(doc_id,doc_date,line_no,job_id,product_id,"
                    + "size_name,iodine,machine_id,pallet,product_no,bag_quatity,"
                    //+ "bag_weight,"
                    + "weight,create_by,create_date,"
                    + "update_date,fraction,job_type,doc_type,h2o_header,butane_header,iod_header,pass_header,n_pass_header,grade_header,remark_header) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public void insert_detail(DataBeand_carbon_send_product_detail DataBean) throws Exception {
        Connection con = new DBConnect().openNewConnection();
        PreparedStatement p = null;
        int i = 1;
        try {
            p = con.prepareStatement("insert into d_carbon_analysis_all_detail(doc_id,doc_date,line_no,job_id,product_id,"
                    + "size_name,iodine,machine_id,pallet,product_no,bag_quatity,"
                    + "weight,create_by,create_date,"
                    + "update_date,fraction,job_type,doc_type,h2o,butane,iod,psd_1,psd_2,psd_3,psd_4,psd_5,"
                    + "psd_6,psd_7,psd_8,psd_9,psd_10,psd_11,psd_12,psd_13,psd_14,psd_15,remark,grade,pass,n_pass,h2o_header"
                    + ",butane_header,iod_header,pass_header,n_pass_header,grade_header,remark_header,param_header_id) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            p.setString(i, DataBean.getDoc_id());
            i += 1;
            p.setString(i, DataBean.getDoc_date());
            ...
            System.out.println("DataBean.getPsd_1() = " + DataBean.getPsd_1());
            i += 1;
            p.setString(i, DataBean.getPsd_2());
            System.out.println("DataBean.getPsd_1() = " + DataBean.getPsd_2());
            i += 1;
            p.setString(i, DataBean.getPsd_3());
            System.out.println("DataBean.getPsd_1() = " + DataBean.getPsd_3());
            i += 1;
            ...
            i += 1;
            p.setString(i, DataBean.getN_pass());
            i += 1;
    ...
    public void update(DataBeand_carbon_send_product_detail DataBean) throws Exception {
        ...
        int i = 1;
        try {
            SQL = "update d_carbon_analysis_all_detail "
                    + "set "
                    ...
                    + "psd_1_header=?,psd_2_header=?,psd_3_header=?,psd_4_header=?,psd_5_header=?,"
                    + "psd_6_header=?,psd_7_header=?,psd_8_header=?,psd_9_header=?,psd_10_header=?,"
                    + "psd_11_header=?,psd_12_header=?,psd_13_header=?,psd_14_header=?,psd_15_header=?,"
                    + "pass=?,grade=?,remark=?,lab_analyze_flag=?,param_header_id=?,wh_iodine=?,lab_emp_id=?,"
                    + "job_id=?,machine_id=?,product_id=?,bag_quatity=?,size_name=?,product_no=?,job_type=?,n_pass=? "
                    + "where doc_id = ? and line_no = ? and delete_flag = 'N' ";
            ...
            p.setString(i, DataBean.getPsd_1_header());
            System.out.println("DataBean.getPsd_1_header() = " + DataBean.getPsd_1_header());
            i += 1;
            p.setString(i, DataBean.getPsd_2_header());
            System.out.println("DataBean.getPsd_2_header() = " + DataBean.getPsd_2_header());
            i += 1;
            p.setString(i, DataBean.getPsd_3_header());
            System.out.println("DataBean.getPsd_3_header() = " + DataBean.getPsd_3_header());
            i += 1;
            p.setString(i, DataBean.getPsd_4_header());
            i += 1;
            p.setString(i, DataBean.getPsd_5_header());
            i += 1;
            p.setString(i, DataBean.getPsd_6_header());
            i += 1;
            p.setString(i, DataBean.getPsd_7_header());
            i += 1;
            p.setString(i, DataBean.getPsd_8_header());
            i += 1;
            p.setString(i, DataBean.getPsd_9_header());
            i += 1;
            p.setString(i, DataBean.getPsd_10_header());
            i += 1;
            p.setString(i, DataBean.getPsd_11_header());
            i += 1;
            p.setString(i, DataBean.getPsd_12_header());
            i += 1;
            p.setString(i, DataBean.getPsd_13_header());
            i += 1;
            p.setString(i, DataBean.getPsd_14_header());
            i += 1;
            p.setString(i, DataBean.getPsd_15_header());
            i += 1;
            ...
            String SQL2 = "SELECT distinct(lab_emp_name) from vd_carbon_analysis_all_detail where doc_id = '" + DataBean.getDoc_id() + "' and delete_flag = 'N' and lab_emp_name is not null";
            ...
            p = null;
            p = con.prepareStatement("update d_carbon_analysis_all_header set lab_emp_name=? where doc_id =? and delete_flag = 'N'");
    ...
    public DataBeand_carbon_send_product_detail Return_Edit(String doc_id, String line_no) throws Exception {
        ...
        UtiDatabase objuti = new UtiDatabase();
        try {
            String SQL = "select * From vd_carbon_analysis_all_detail where doc_id = '" + doc_id + "' and line_no = '" + line_no + "' and delete_flag = 'N' ";
            System.out.println(SQL);
    ...
    public String ShowDetail(String doc_id) throws Exception {
        ...
        Connection con = new DBConnect().openNewConnection();
        ResultSet rs = null;
        String SQL = "select count(doc_id) as num from vd_carbon_analysis_all_detail where doc_id = '" + doc_id + "' and delete_flag = 'N' ";
        ...
        try {
            ...
            if (objuti.numRowdatabase(SQL) == 0) {
                ...
                SQL = "select * from vd_carbon_analysis_all_detail where doc_id = '" + doc_id + "' and delete_flag = 'N' order by to_number(line_no,'990')";
                rs = con.createStatement().executeQuery(SQL);
                while (rs.next()) {
                    ...
                    str_return.append("<td class='forborder' width='3%'><a href=\"#\"  class='link_data_transparent' onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",doc_id,dept_id,A_username,emp_id,emp_fullname','../SCREEN/CS_Detail_D_carbon_analysis_detail.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a></td>");
                    ...
                    str_return.append("<td class='forborder' width='10%'>" + rs.getString("remark") + "</td>");
                    str_return.append("</tr>");
                }
            }
