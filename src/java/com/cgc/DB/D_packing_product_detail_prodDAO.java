 ...
 */
public class D_packing_product_detail_prodDAO {
    ...
    public int insert(DataBeanD_packing_product_detail_prod dataBean) throws Exception {
        ...
        try {
            ...
            String SqlCount = "Select Count(doc_id) As num from  d_packing_product_detail_prod where doc_id = '" + dataBean.getDoc_id() + "' and delete_flag = 'N' and line_no = '" + dataBean.getLine_no() + "' ;";
    ...
    public int update(DataBeanD_packing_product_detail_prod dataBean) throws Exception {
        ...
        String sql = "update d_packing_product_detail_prod set  "
                + "wh_id=?,product_id=?,size=?,i2=?,bag=?,weight=?,remark=?,update_date=?,update_by=?,weight_unit=?,product_no=?,pack_repacking_status=?,carbon_trap_status=?,doc_type=?"
        ...
        try {
            ...
            p.setString(12, dataBean.getPack_repacking_status());
            p.setString(13, dataBean.getCarbon_trap_status());
    ...
    public String showDetail(String doc_id) throws Exception {
        ...
        String SQL1, SQL;
        //String strOutput = "";
        String strOutput = "<table width='100%' align='center' border='0' cellpadding='0' cellspacing='1' class='inner'>";
        ...
        try (Connection con = objcon.openNewConnection()) {
            ...
            while (rs.next()) {
                ...
                strOutput += "<td class='forborder' width='7%'><a href=\"#\"  class='link_data_transparent' onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",doc_id,total_bag,total_weight,username','../SCREEN/CS_044.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\">" + rs.getString("line_no") + "</a></td>";
