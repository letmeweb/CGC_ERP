 ...
 * @author
 */
public class Process_production_detail_track_process_DB {
    ...
    public void generater_transaction_process(String job_id, String user_login, Timestamp ts) throws Exception {
        ...
        String job_type_id = "('001','002','003','004','005','006','007','010')";
        ...
        try {
            ...
            SQL_Res1 = " select * from " + Table_Detail_prod + " where job_id = '" + job_id + "'"
                    ...
                    // Test
                    + " and job_type_id in " + job_type_id
                    + " order by to_date(format_date(doc_date),'YYYY-MM-DD')";

            System.out.println("Process2 SQL_Res1 = " + SQL_Res1);
            ...
            System.out.println("HeaderXXX SQL_Res3" + SQL_Res3);
            ...
            while (rs.next()) {
                ...
                System.out.println("day_sum.length  = " + day_sum.length);
