...
public class D_quality_rawmatt_receive_rateDAO {
    ...
    public DataBeanD_quality_rawmatt_receive_rate_header Return_Header(DataBeanD_quality_rawmatt_receive_rate_header obj_Bean, Connection con, ResultSet rs) throws Exception {
        ...
        try {
            switch (select_rate) {
                case 1:
                    SQL = "select "
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '01-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value1,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '02-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value2,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '03-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value3,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '04-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value4,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('01-" + obj_Bean.getYear() + "','02-" + obj_Bean.getYear() + "','03-" + obj_Bean.getYear() + "','04-" + obj_Bean.getYear() + "') and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as total_value,"
                            + "(select sum(to_number(carbon_net,'9999990.00')) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('01-" + obj_Bean.getYear() + "','02-" + obj_Bean.getYear() + "','03-" + obj_Bean.getYear() + "','04-" + obj_Bean.getYear() + "') and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as car_in_weight,"
                            + "(select sum((to_number(carbon_net,'9999990.00')-to_number(net_weight_ch,'9999990.00'))) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id()
                            + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('01-" + obj_Bean.getYear()
                            + "','02-" + obj_Bean.getYear()
                            + "','03-" + obj_Bean.getYear()
                            + "','04-" + obj_Bean.getYear() + "') "
                            + "and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as cut_weight,"
                            + "(select sum(to_number(net_weight_ch,'9999990.00')) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id()
                            + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('01-" + obj_Bean.getYear()
                            + "','02-" + obj_Bean.getYear()
                            + "','03-" + obj_Bean.getYear()
                            + "','04-" + obj_Bean.getYear() + "') "
                            + "and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as net_weight"
                            + " from vd_rawmatt_receive  where delete_flag = 'N'  group by value1,value2,value3,value4,total_value ";
                ...
                case 2:
                    SQL = "select "
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '05-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value1,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '06-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value2,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '07-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value3,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '08-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value4,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('05-" + obj_Bean.getYear()
                            + "','06-" + obj_Bean.getYear()
                            + "','07-" + obj_Bean.getYear()
                            + "','08-" + obj_Bean.getYear() + "') and product_id ='"
                            + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as total_value,"
                            + "(select sum(to_number(carbon_net,'9999990.00')) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id()
                            + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('05-" + obj_Bean.getYear()
                            + "','06-" + obj_Bean.getYear()
                            + "','07-" + obj_Bean.getYear()
                            + "','08-" + obj_Bean.getYear() + "') and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as car_in_weight,"
                            + "(select sum((to_number(carbon_net,'9999990.00')-to_number(net_weight_ch,'9999990.00'))) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id()
                            + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('05-" + obj_Bean.getYear()
                            + "','06-" + obj_Bean.getYear()
                            + "','07-" + obj_Bean.getYear()
                ...
                case 3:
                    SQL = "select "
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '09-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value1,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '10-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value2,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '11-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value3,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') = '12-" + obj_Bean.getYear() + "' and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as value4,"
                            + "(select trim(to_char(count(supplier_id),'990')) :: character varying from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id() + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('09-" + obj_Bean.getYear()
                            + "','10-" + obj_Bean.getYear()
                            + "','11-" + obj_Bean.getYear()
                            + "','12-" + obj_Bean.getYear() + "') and product_id ='"
                            + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as total_value,"
                            + "(select sum(to_number(carbon_net,'9999990.00')) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id()
                            + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('09-" + obj_Bean.getYear()
                            + "','10-" + obj_Bean.getYear()
                            + "','11-" + obj_Bean.getYear()
                            + "','12-" + obj_Bean.getYear() + "') and product_id ='" + obj_Bean.getProduct_id() + "' and delete_flag = 'N' ) as car_in_weight,"
                            + "(select sum((to_number(carbon_net,'9999990.00')-to_number(net_weight_ch,'9999990.00'))) from vd_rawmatt_receive where supplier_id = '" + obj_Bean.getSupplier_id()
                            + "' and to_char(to_date(doc_date,'DD-MM-YYYY'),'MM-YYYY') in ('09-" + obj_Bean.getYear()
                            + "','10-" + obj_Bean.getYear()
                            + "','11-" + obj_Bean.getYear()
    ...
    public ArrayList<DataBeanD_quality_rawmatt_receive_rate_detail> Return_Detail(DataBeanM_quality_rawmatt_receive Bean_m_quality,
        ...
        try {
            SQL = "select "
                    + "(select trim(to_char(count(ashes_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(ashes_percent,'990.00') <= " + Bean_m_quality.getAshes_value1() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as ashes_percent_count1,"//ขี้เถ่า
                    + "(select trim(to_char(count(ashes_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(ashes_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getAshes_value2() + "'),'90.00') and  to_number(ashes_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getAshes_value2() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as ashes_percent_count2,"
                    + "(select trim(to_char(count(ashes_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(ashes_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getAshes_value3() + "'),'90.00') and  to_number(ashes_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getAshes_value3() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as ashes_percent_count3,"
                    + "(select trim(to_char(count(ashes_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(ashes_percent,'990.00') > " + Bean_m_quality.getAshes_value4() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as ashes_percent_count4,  "
                    + "(select trim(to_char(count(dust_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(dust_percent,'990.00') <= " + Bean_m_quality.getDust_value1() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as dust_percent_count1,"//--ฝุ่น
                    + "(select trim(to_char(count(dust_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(dust_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getDust_value2() + "'),'90.00') and  to_number(dust_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getDust_value2() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as dust_percent_count2,"
                    + "(select trim(to_char(count(dust_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(dust_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getDust_value3() + "'),'90.00') and  to_number(dust_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getDust_value3() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as dust_percent_count3,"
                    + "(select trim(to_char(count(dust_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(dust_percent,'990.00') > " + Bean_m_quality.getDust_value4() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as dust_percent_count4,  "
                    + "(select trim(to_char(count(volatile_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(volatile_percent,'990.00') <= " + Bean_m_quality.getVolatile_value1() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as volatile_percent_count1,"//--การระเหย
                    + "(select trim(to_char(count(volatile_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(volatile_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getVolatile_value2() + "'),'90.00') and  to_number(volatile_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getVolatile_value2() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as volatile_percent_count2,"
                    + "(select trim(to_char(count(volatile_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(volatile_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getVolatile_value3() + "'),'90.00') and  to_number(volatile_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getVolatile_value3() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as volatile_percent_count3,"
                    + "(select trim(to_char(count(volatile_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(volatile_percent,'990.00') > " + Bean_m_quality.getVolatile_value4() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as volatile_percent_count4, "
                    + "(select trim(to_char(count(moise_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(moise_percent,'990.00') <= " + Bean_m_quality.getMoise_value1() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as moise_percent_count1,"//--ความชื้น
                    + "(select trim(to_char(count(moise_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(moise_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getMoise_value2() + "'),'90.00') and  to_number(moise_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getMoise_score2() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as moise_percent_count2,"
                    + "(select trim(to_char(count(moise_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(moise_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getMoise_value3() + "'),'90.00') and  to_number(moise_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getMoise_score3() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as moise_percent_count3,"
                    + "(select trim(to_char(count(moise_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(moise_percent,'990.00') > " + Bean_m_quality.getMoise_value4() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as moise_percent_count4,  "
                    + "(select trim(to_char(count(contamination_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(contamination_percent,'990.00') <= " + Bean_m_quality.getContamination_value1() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as contamination_percent_count1,"//--สิ่งเจอปน
                    + "(select trim(to_char(count(contamination_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(contamination_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getContamination_value2() + "'),'90.00') and  to_number(contamination_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getContamination_score2() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as contamination_percent_count2,"
                    + "(select trim(to_char(count(contamination_percent),'990')) :: character varying from vd_rawmatt_receive where (to_number(contamination_percent,'990.00') >= to_number(substring_begin('" + Bean_m_quality.getContamination_value3() + "'),'90.00') and  to_number(contamination_percent,'990.00') <= to_number(substring_end('" + Bean_m_quality.getContamination_score3() + "'),'90.00')) and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as contamination_percent_count3,"
                    + "(select trim(to_char(count(contamination_percent),'990')) :: character varying from vd_rawmatt_receive where to_number(contamination_percent,'990.00') > " + Bean_m_quality.getContamination_value4() + " and supplier_id = '" + supplier_id + "' and (to_date(format_date(doc_date),'YYYY-MM-DD') between '" + (select_rate == 1 ? year + "-01-01" : select_rate == 2 ? year + "-05-01" : year + "-09-01") + "' and '" + (select_rate == 1 ? year + "-04-30" : select_rate == 2 ? year + "-08-31" : year + "-12-31") + "') and product_id = '" + product_id + "' and delete_flag = 'N' ) as contamination_percent_count4  "
                    + "from vd_rawmatt_receive  where product_id = '" + product_id + "' and  delete_flag = 'N'  "
                    + "group by "
    ...
    public DataBeanD_quality_rawmatt_receive_rate_header Total_Quality_value(DataBeanD_quality_rawmatt_receive_rate_header Bean_header, ArrayList<DataBeanD_quality_rawmatt_receive_rate_detail> AL_bean) throws Exception {
        ...
        try {
            ...
            System.out.println("Bean_header.getDividend()" + Bean_header.getDividend());
            System.out.println("Bean_header.getDenominator()" + Bean_header.getDenominator());

            quality_value = ((Double.parseDouble(Bean_header.getDividend()) / Double.parseDouble(Bean_header.getDenominator())) * 100);            

            System.out.println("quality_value = " + df.format(Decimal_Place.Round(((Double.parseDouble(Bean_header.getDividend()) / Double.parseDouble(Bean_header.getDenominator())) * 100), 2)));
            
            S_quality_value = df.format(Decimal_Place.Round(((Double.parseDouble(Bean_header.getDividend()) / Double.parseDouble(Bean_header.getDenominator())) * 100), 2)) ;          

            Bean_header.setQuality_value(S_quality_value);
