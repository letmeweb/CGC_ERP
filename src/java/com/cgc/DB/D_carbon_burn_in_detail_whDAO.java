...
//"+(rs.getString("complete_flag").equals("N")?"<input type='checkbox' id='ckbox' name='ckbox' onclick=\"cancle_chkboxAll('chk_all',this.checked)\">":"&nbsp;")+"
        ...
        try {
            ...
            while (rs.next()) {
                ...
                strOutput.append("<td class='forborder' width='7%'>"+(rs.getString("complete_flag").equals("N")?"<a href=\"#\"  class='link_data_transparent' onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",doc_id,total_weight,username','../SCREEN/CS_028_2.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a>":rs.getString("line_no"))+"</td>");
