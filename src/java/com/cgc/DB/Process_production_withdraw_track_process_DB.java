 ...
 */
public class Process_production_withdraw_track_process_DB {
    ...
    public void generater_transaction_process(String job_id) throws Exception {
        ...
        //String Table_Header = "vd_product_receive_header";
    ...
    private void insert_product(DataBeanD_product_receive_process_track_detail dataBean, Connection con, PreparedStatement p) throws Exception {
        ...
        try {
            ...
            SQL_Insert = "insert into d_product_receive_process_track_detail"
                    + "(d_1,d_2,d_3,d_4,d_5,d_6,d_7,d_8,d_9,d_10,d_11,d_12,d_13,d_14,d_15,d_16,d_17,d_18,d_19,d_20,d_21,d_22,d_23,d_24,d_25,d_26,d_27,d_28,d_29,d_30,d_31,doc_id,doc_type,job_id,shift,size,machine,month,year) "
                    + "values(?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?)";
    ...
    private void insert_product_header(DataBeanD_product_receive_process_track_header dataBean_header, Connection con, PreparedStatement p) throws Exception {
        ...
        try {
            ...
            SQL_Insert = " insert into d_product_receive_process_track_header "
                    + " (d_1,d_2,d_3,d_4,d_5,d_6,d_7,d_8,d_9,d_10,d_11,d_12,d_13,d_14,d_15,d_16,d_17,d_18,d_19,d_20,d_21,d_22,d_23,d_24,d_25,d_26,d_27,d_28,d_29,d_30,d_31,job_id,machine,size,month,year) "
                    + " values(?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?,?,?,?,?"
                    + ",?,?,?,?,?,?)";
