 ...
 */
public class D_packing_product_headerDAO {
    ...
    public int update(DataBeanD_packing_product_header dataBean) throws Exception {
        ...
        String[] column_cal = new String[]{"bag", "weight"};
        //String[] column_cal_total = new String[]{"bag_doc_type", "weight_doc_type"};
        String[] column_cal_total = new String[]{"bag", "weight"};
        String[] column_cal_total_withdraw_over = new String[]{"bag", "weight"};
        UtiDatabase objuti = new UtiDatabase();
        ...
        try {
            ...
            p.setString(5, dataBean.getEmp_id());
            p.setString(6, dataBean.getShift());
            p.setString(7, dataBean.getWh_in());
            p.setString(8, dataBean.getWh_out());
            p.setString(9, dataBean.getLost_weight());
            p.setString(10, objuti.NotNull(dataBean.getTotal_bag_withdraw(), "0"));
            p.setString(11, objuti.NotNull(dataBean.getTotal_weight_withdraw(), "0"));
            p.setString(12, objuti.NotNull(dataBean.getTotal_bag(), "0"));
            p.setString(13, objuti.NotNull(dataBean.getTotal_weight(), "0"));
            p.setTimestamp(14, dataBean.getDate());
            p.setString(15, dataBean.getBy());
            p.setString(16, dataBean.getRunner_id());
            p.setString(17, dataBean.getComplete_flag());
            p.setString(18, Count_sendcomplete("d_packing_product_header", dataBean.getDoc_id(), dataBean.getComplete_flag(), con));
    ...
    public void UpDel_wh(DataBeanD_packing_product_header dataBean) throws Exception {
        Returnvalue = 0;
        DBConnect dbConnect = new DBConnect();
        Connection con = dbConnect.openNewConnection();
        String sqlheader = "update d_packing_product_header_wh set delete_flag = ?,delete_date=?,delete_by=? where doc_id=? ";
        String sqldetail = "update d_packing_product_detail_wh set delete_flag = ?,delete_date=?,delete_by=? where doc_id=? ";
        String sqldetail_prod = "update d_packing_product_detail_prod_wh set delete_flag = ?,delete_date=?,delete_by=? where doc_id=? ";
        PreparedStatement p;
        try {
            for (int i = 0; i < 3; i++) {
                if (i == 0) {
    ...
    private void CopyToD_packing_product_wh(DataBeanD_packing_product_header dataBean) throws Exception {
        ...
        String SQLinsert_header = "insert into d_packing_product_header_wh "
                ...
                + " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        String SQLinsert_detail = "insert into d_packing_product_detail_wh "
