 ...
 */
public class PrintReport_Rawmat_bigbag_balance_1_new {
            ...
            for (int x = 1; x <= 3; x = x + 1) {
                ...
                if (x == 1) {
                    ...
                    if (Integer.parseInt(month_id) == 1) {
                        ...
                        condition = Cond0 + Cond1 + " and (process_id = 'PR_025' or process_id <> 'PR_117') and pcat_id = 'RAW' ";
                    }
                } else if (x == 2) {
                    ...
                    if (Integer.parseInt(month_id) == 1) {
                        ...
                        condition = Cond0 + Cond1 + " and (process_id = 'PR_025' or process_id = 'PR_117' or process_id = 'PR_057') and pcat_id <> 'RAW' ";
                    }
