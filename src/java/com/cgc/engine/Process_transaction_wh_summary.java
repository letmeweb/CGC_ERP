...
public class Process_transaction_wh_summary {
    ...
    public String main_check(String date_from, String date_to, String username, String process_for, String log_id) throws Exception {
        ...
        try {
            ...
            if (ddays >= 17) {
                System.out.println("Loop ddays >= 17 ");
    ...
    public void startProcess(final String Time_Loop, final String date_from_send, final String date_to_send, final String log_id, final String username) throws Exception {
            ...
            public void run() {
                try {
                    try {
                        ...
                        Process_transaction_wh_summaryDB_New obj = new Process_transaction_wh_summaryDB_New();
                        System.out.println("startProcess ... " + Time_Loop + " date_from_send = " + date_from_send + " date_to_send = " + date_to_send);
                        obj.generater_transaction_process(Time_Loop, date_from_send, date_to_send, "PR_WH_STOCK_VALUE", "vt_transaction_stock_process_report_wh_sum", "*", log_id, username);
                    } catch (Exception ex) {
        ...
        System.out.println("Thread(runnable).start() = " + chk++);
    }
}
