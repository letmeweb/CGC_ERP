 ...
 * @author Beck
 */
public class Cal_Total_Withdraw_Over {
    //DataBeanCalculate
    ...
    public Cal_Total_Withdraw_Over(String Table_name, String Column_name, String Doc_ID, String Stadment_Where) throws Exception {
    ...
    public Cal_Total_Withdraw_Over(String Table_name, String[] Column_name, String Doc_ID, String Stadment_Where, int ArrayMem) throws Exception {
        objbean = new DataBeanCalculate();
        DBConnect objcon = new DBConnect();
        Connection con = objcon.openNewConnection();
        ResultSet rs = null;
