...
public class Cal_Total {
    ...
    public Cal_Total(String Table_name, String Column_name, String Doc_ID, String Stadment_Where) throws Exception {
        ...
        try {
            ...
            df.applyPattern("##0");
            Total = 0;
            SQL = "SELECT trim(to_char(sum(to_number("+Column_name+",'999999990')),'999999990')) as cal_total FROM " + Table_name + " WHERE doc_id = '" + Doc_ID + "' and delete_flag <> 'Y' " + Stadment_Where;
            System.out.println("SQL Cal = " + SQL);
    ...
    public Cal_Total(String Table_name, String[] Column_name, String Doc_ID, String Stadment_Where,int ArrayMem) throws Exception {
        objbean = new DataBeanCalculate();
        DBConnect objcon = new DBConnect();
        Connection con = objcon.openNewConnection();
        ResultSet rs = null;
        ...
        try {
            ...
            SQL = "SELECT " + strMath + " FROM " + Table_name + " WHERE doc_id = '" + Doc_ID + "' and delete_flag <> 'Y' " + Stadment_Where;
