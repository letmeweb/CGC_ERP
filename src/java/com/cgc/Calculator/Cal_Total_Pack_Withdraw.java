 ...
 * @author Beck
 */
public class Cal_Total_Pack_Withdraw {
    //DataBeanCalculate
    ...
    public Cal_Total_Pack_Withdraw(String Table_name, String Column_name, String Doc_ID, String Stadment_Where) throws Exception {
    ...
    public Cal_Total_Pack_Withdraw(String Table_name, String[] Column_name, String Doc_ID, String Stadment_Where,int ArrayMem) throws Exception {
        objbean = new DataBeanCalculate();
        DBConnect objcon = new DBConnect();
        Connection con = objcon.openNewConnection();
        ResultSet rs = null;
        ...
        try {
            ...
            if (Table_name.equals("vd_packing_product_detail")) {
                SQL = "SELECT " + strMath + " FROM " + Table_name + " WHERE doc_id = '" + Doc_ID + "' and delete_flag <> 'Y' and (pack_repacking_status = 'N' or doc_type = '+')  " + Stadment_Where;
            } else {
