...
<html>
    ...
    <body>
        ...
        <h2><center>Return Document คืนเอกสารการเบิกถ่านเพื่อผลิต</center></h2>
        ...
        // Note: this is set up to look in the same directory as the jsp file.
            String fileName = "data_carbon_withdraw_to_production.txt";
        ...
        // 'application' is a freebie from the parent servlet.
                ...
                while (line != null) {
                    out.println("update d_carbon_withdraw_header set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("update d_carbon_withdraw_detail set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("delete from d_carbon_withdraw_header_wh  where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("delete from d_carbon_withdraw_detail_wh  where doc_id = '" + line + "' ;");
                    out.println("<BR>");
        %>
        <%
                    line = br.readLine();
