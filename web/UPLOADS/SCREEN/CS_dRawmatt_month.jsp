    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <%
                ...
                String s_prev_month = String.valueOf(prev_month);
                System.out.println("prev_month = " + prev_month);
                System.out.println("s_prev_month = " + s_prev_month);
...
%>       
        ...
        <tr>         
            ...
            <%
                ...
                String sql_where_prev = "";   
               
                if (prev_month>0) {                    
                    
                    sql_where_prev = " WHERE substr(doc_date,4,2) between '01' AND " + s_prev_month;
