    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function get_search() {
                ...
                alert("Day = " + year + " : " + month + " - " + daysInMonth(year, month));
            ...
            <div align="center">
                <table  cellpadding="0"  cellspacing="0">
                    <tr >
                        ...
                        <td  class="ftopcenter" colspan="2">ค้นหาใบแจ้งการผลิต (CS_Report_Job_Order_document)&nbsp;</td>
                        ...
                        <td  colspan="2" class="fcentercenter">
                            <div align="center">
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        <td class="columnlabel">ลูกค้า&nbsp;</td>
