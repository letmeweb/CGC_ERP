                        ...
                        <table width="94%"  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td width="600" class="columnobject"><input name='doc_id' type='text' class="inputs" id="doc_id" value='' size='10' />
                                    &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_analyze_packing_header&stadment=and+complete_flag+<>+\'Y\'', 106, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                    วันที่เอกสาร*&nbsp;
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name='prd_no' type='text' class="inputs" id="prd_no" value='' size='15' />
                                    <a href='javascript:;' onClick="javascript:openBrWindow('Vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 106, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="columnobject"><input name='cust_id' type='text' class="inputs" id="cust_id" value='' size='15' />
                                    ...
                                    <a href='javascript:;'>
                                        <input name='cust_id_desc' type='text' class="inputs" id="cust_id_desc" value='' size='30' />
                                    </a></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ขนาด*&nbsp;</td>
                                <td class="columnobject"><input name='size' type='text' class="inputs" id="size" value='' size='10' />
                                    &nbsp;&nbsp;&nbsp;จำนวน
                                    <input name='quantity' type='text' class="inputs" id="quantity" value='' size='10' />
                                    ตัน</td>
                            </tr>
                            <tr>
