        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>ประมวลผลสรุปข้อมูลสินค้ารายวัน (CS_Trans_Sum_Daily_Header)</b>
                </div>                

                <div class="panel-footer">            

                    <form name ="report" action="CS_Trans_Sum_Daily_Detail.jsp" target="_blank" method ="post">
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <!--tr>
                                ...
                                <td class="columnobject"><input name="pgroup_id" type='text' class="inputs" id="pgroup_id" value="" size="20" readonly>&nbsp;&nbsp;<a href='#' onClick="openBrWindow('mproduct_group', 21, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                            ...
                            <tr>
                                ...
                                <td class='columnobject'><input name="date_t" type='text' class="inputs" id="date_t" value="<%=end_current_month%>" readonly/>
                                    &nbsp;<a id='date_2' href="javascript:;" data-toggle="tooltip" title="สิ้นสุดวันที่"><img name='IMAGE4' src='../IMAGES/BUTTON/MAIN/CALENDAR20.png' border='0' align='absmiddle'></a>
                        ...
                        <button id = "newThread" class="btn btn-primary btn-block" type="submit" data-toggle="tooltip" title="กดปุ่มเพื่อประมวลผล" onclick="CheckDate()"><b>ประมวลผล</b></button>
                </div>
            </div>
        </div>    
    </body>
