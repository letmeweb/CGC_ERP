                    ...
                    <div class="container">
                        <div class="panel panel-primary">
                            <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                                <b>ผลวิเคราะห์คุณภาพถ่านออกจากเตา(CS_D_carbon_out_analysis)</b>
                            </div>                        
                            <div class="panel-footer">                  
                                ...
                                <div align="center">
                                    <table  cellpadding="0" cellspacing="0" >
                                        ...
                                        <tr>
                                            <td width="150" class="columnlabel1"><strong>เลขที่เอกสาร*</strong>&nbsp;</td>
                                            <td width="503" class="columnobject">
                                                <input name='doc_id' type='text' class="inputs1" id="doc_id" value='' size='12'  />
                                                ...
                                                <input name='doc_date' type='text' class="inputs1" id="doc_date" value='' size='10' readonly="readonly" />
                                        ...
                                        <tr>
                                            <td width="150" class="columnlabel1"><strong>เลขที่เอกสาร(ตรวจสอบแล้ว)</strong>&nbsp;</td>
                                            <td width="503" class="columnobject">
                                                <!--input name='doc_id' type='text' class="inputs1" id="doc_id" value='' size='10' readonly/-->
                                            ...
                                            <td colspan="2" align="center">
                                                <div style="width:100%;">
                                                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                        <tr>
                                                            <td class="columnlabel1"><strong>ประเภท</strong>&nbsp;</td>
                                                            <td class="columnobject">
                                                                <select class='select_cgc2' name="ctype" id="ctype">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="6" class="btn_multi">
                                                                <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="javascript:getId('status_cancle').value == '1' ? goAddChild(URLsend('doc_id,username,status_a,tdate1,tname1,ttime1,tdate2,tname2,ttime2,tdate3,tname3,ttime3', 'CS_Detail_D_carbon_out_analysis.jsp')) : CreateNewRow();"/>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="row3" width="1%"></td>
                                                            <td class="row3" width="15%">วันที่<br><a id='date_2' ><input name="tdate1" type='text' class="inputs1" id="tdate1" size="10" onmousedown="Calendar.setup({inputField: 'tdate1', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_2', singleClick: true, step: 1});"></a></td>
                                                            <td class="row3" width="15%">หมายเลขเตา<br><input name="tname1" type='text' class="inputs1" id="tname1" size="10" maxlength="1" ></td>
                                                            <td class="row3" width="15%">เวลา (น.)<br><input name='ttime1' type='text' class="inputs1" id="ttime1" value='' size='10' maxlength="5"  onkeypress="Time_picker(this.id)" /></td>                                                             
                                                            <td class="row3" width="15%">วันที่<br><a id='date_3' ><input name="tdate2" type='text' class="inputs1" id="tdate2" size="10" onmouseover="Calendar.setup({inputField: 'tdate2', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_3', singleClick: true, step: 1});"></a></td>
                                                            <td class="row3" width="15%">หมายเลขเตา<br><input name="tname2" type='text' class="inputs1" id="tname2" size="10" maxlength="1"></td>
                                                            <td class="row3" width="15%">เวลา (น.)<br><input name='ttime2' type='text' class="inputs1" id="ttime2" value='' size='10' maxlength="5"  onkeypress="Time_picker(this.id)" /></td> 
                                                            <td class="row3" width="15%">วันที่<br><a id='date_4' ><input name="tdate3" type='text' class="inputs1" id="tdate3" size="10" onmouseover="Calendar.setup({inputField: 'tdate3', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_4', singleClick: true, step: 1});"></a></td>
                                                            <td class="row3" width="15%">หมายเลขเตา<br><input name="tname3" type='text' class="inputs1" id="tname3" size="10" maxlength="1"></td>
                                                            <td class="row3" width="15%">เวลา (น.)<br><input name='ttime3' type='text' class="inputs1" id="ttime3" value='' size='10' maxlength="5"  onkeypress="Time_picker(this.id)" /></td>                                                        
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="columnobject"><input name="reporter_id" type='text' class="inputs1" id="reporter_id" size="15">
                                                ...
                                                <input name="reporter_id_desc" type='text' class="inputs1" id="reporter_id_desc" size="30">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="columnlabel1">ผู้ตรวจสอบ</td>
                                            <td class="columnobject"><input name="approve_id" type='text' class="inputs1" id="approve_id" size="15">
                                                ...
                                                <input name="approve_id_desc" type='text' class="inputs1" id="approve_id_desc" size="30">
                                            </td>
                                        </tr>
                                        <tr>
