    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave(URLsend('doc_id,wh_in,wh_out,doc_date,product_id,weight,bag,lot_no,remark,status_a,username,quantity,job_id', '../JSP/CS_043.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave(URLsend('doc_id,wh_in,wh_out,doc_date,product_id,weight,bag,lot_no,remark,line_no,status_u,username,quantity,job_id', '../JSP/CS_043.jsp'));
