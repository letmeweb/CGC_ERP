                ...
                <td  colspan="2" class="fcentercenter">
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td height="22" class="columnlabel">&nbsp;</td>
                                <td colspan="15" class="columnobject">&nbsp;</td>
                            </tr>
                            <tr>
                                <td height="22" class="columnlabel">&nbsp;</td>
                            ...
                            <tr>
                                <td class="columnlabel">เลขที่ใบแจ้งการผลิต</td>
                                <td class="columnobject"><a href='javascript:;' onClick="openBrWindow('vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 109, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="15" class="columnobject"><input type="radio" name="status1" id="pass" value="Y" onClick="javascript:getId('valuepass').value = this.value;">
                                    ...
                                    ไม่ผ่าน
                                    <input name="valuepass" type="hidden" id="valuepass" value=""></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">grade*&nbsp;</td>
                                <td colspan="15" class="columnobject"><input name="grade" type='text' class="inputs" id="grade" size="20" value=""></td>
                            </tr>
                            <tr>
                              <td height="51" class="columnlabel">&nbsp;</td>
                              <td colspan="15" class="columnobject"  ><div align="right">&nbsp;</div></td>
                            </tr>-->
                            <tr>
                                <td height="51" class="columnlabel">&nbsp;</td>
