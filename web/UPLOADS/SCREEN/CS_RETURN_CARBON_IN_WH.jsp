...
<html>
    ...
    <body>
        ...
        <h2><center>Return Document คืนเอกสารถ่านเติมเตา (ฝ่ายรับวัตถุดิบ)</center></h2>
        ...
        // Note: this is set up to look in the same directory as the jsp file.
            String fileName = "data_carbon_in_wh.txt";
        ...
        // 'application' is a freebie from the parent servlet.
                ...
                while (line != null) {
                    out.println("update d_carbon_burn_in_header_wh set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("update d_carbon_burn_in_detail_wh set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
        %>
        <%
                    line = br.readLine();
