...
<html>
    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <input type="hidden" name="report_code" value="RP_015_RAW_BALANCE_LOCATION">
            ...
            <%
                ...
                String table_stk = "tmp_stock_raw_balance_location";
                ...
                String SqlFeature = " group by product_id,location_id,pname_t,pgroup_id,pgroup_name,pcat_id,pcat_name,ptype_id,ptype_name,unit_name,weight_per_unit"
                        //+ " having sum(weight_total) > 0"
                        + " order by pgroup_id desc ,product_id ,location_id ";

                //System.out.println("sql_where = " + sql_where);
                SqlSelectSTK = " select product_id,location_id,pname_t,pgroup_id,pgroup_name,"
                ...
                while (rec_wh_stock != null && (rec_wh_stock.next())) {
                    ...
                    SqlInsertSTK = "INSERT INTO " + table_stk + " (doc_id,doc_date,line_no,pgroup_id,product_id,location_id,weight,price_per_unit,total_price,ptype_id,pcat_id,create_by,create_date,remark,doc_type) VALUES "
                            + "('" + doc_id + String.format("%04d", Run_Doc_Id) + "','" + doc_date + "','" + Row_Page
                            + "','" + rec_wh_stock.getString("pgroup_id") + "','" + rec_wh_stock.getString("product_id")
                            + "','" + rec_wh_stock.getString("location_id")
