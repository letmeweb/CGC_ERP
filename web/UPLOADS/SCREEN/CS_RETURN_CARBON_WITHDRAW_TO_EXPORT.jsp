...
<html>
    ...
    <body>
        ...
        <h2><center>Return Document คืนเอกสารการเบิกถ่านเพื่อส่งออก</center></h2>
        ...
        // Note: this is set up to look in the same directory as the jsp file.
            String fileName = "data_withdraw_product_to_export.txt";
        ...
        // 'application' is a freebie from the parent servlet.
                ...
                while (line != null) {
                    out.println("update d_requisition_product_header set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("update d_requisition_product_detail set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("delete from d_requisition_product_header_wh  where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("delete from d_requisition_product_detail_wh  where doc_id = '" + line + "' ;");
                    out.println("<BR>");
        %>
        <%
                    line = br.readLine();
