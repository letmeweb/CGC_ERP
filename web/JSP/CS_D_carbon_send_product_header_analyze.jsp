...
<%
    ...
    if (request.getParameter("D_status") == null && request.getParameter("status_runid") == null) {
        ...
        //statusnum = uti.numRowdatabase("SELECT Count(doc_id) As num from  d_carbon_send_product_header where doc_id = '" + request.getParameter("A_doc_id") + "' and delete_flag = 'N' and wh_leader_confirm = 'N'");
