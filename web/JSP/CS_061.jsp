...
<%
    ...
    ppBean.setDoc_type(request.getParameter("doc_type") == null ? "" : en.EncodeTexttoTIS(request.getParameter("doc_type")));
    System.out.println("Doc Type = " + request.getParameter("doc_type"));
    ...
    if (request.getParameter("status_copy") == null) {
        ...
        if (request.getParameter("chkstatus") == null) {
            ...
            if (selectPpBean != null && selectPpBean.getDelete_flag().equals("N")) {
                ...
                ppBean.setDoc_id(objrunno.Run_id_parameter("d_header_analyze",request.getParameter("doc_type")));                
                ppBean.setJob_id(objrunno.Run_id_parameter("d_header_analyze",request.getParameter("doc_type")));
