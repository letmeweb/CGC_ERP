...
<%
    ...
    if (runer_id != null) {
        ...
        if (runer_id.equals("1")) {
            Sql_Str = " select count(*) as record_count from d_carbon_friction_header where complete_flag <> 'Y' ";    
        } else if (runer_id.equals("2")) {
            Sql_Str = " select count(*) as record_count from d_rawmatt_bigbag_withdraw_header where complete_flag <> 'Y' ";
        }        
