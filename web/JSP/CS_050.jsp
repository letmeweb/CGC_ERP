...
<%
            ...
            for (int i = 0; i < cnt; i++) {
                ...
                tStockBean.setLocation_id(list[5]); //*** get Location_out form CS_050
                ...
                if (whBean != null) {
                    ...
                    whData.setLocation_id(list[5]); //*** get Location_out form CS_050
                ...
                tStockBean.setLocation_id(list[3]); //*** get Location_in form CS_050
                tStockBean.setDoc_type("+");
                ...
                if (whBean != null) {
                    ...
                    whData.setLocation_id(list[3]); //*** get Location_in form CS_050
                    whData.setProduct_id(list[1]);
                    double quant = Double.parseDouble(whBean.getWeight()) + Double.parseDouble(list[4]);
                    whData.setWeight(quant + "");
