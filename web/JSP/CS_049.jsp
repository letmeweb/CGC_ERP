...
<%
            ...
            for (int i = 0; i < cnt; i++) {
                ...
                mProcess = proDAO.selectData("PR_029");

                //******************* transtock - *****************
                
                tStockBean.setDoc_no(list[0]);
                tStockBean.setProcess_id("PR_029");
                tStockBean.setLocation_id(list[6]); //*** get Location_out form CS_049
                tStockBean.setProduct_id(list[2]);
                tStockBean.setWeight(list[5]);
                ...
                if (whBean != null) {
                    ...
                    whData.setLocation_id(list[6]); //*** get Location_out form CS_049
                    whData.setProduct_id(list[2]);
                    double quant = Double.parseDouble(whBean.getWeight()) - Double.parseDouble(list[5]);
                    ...
                    double quant_T = Double.parseDouble(whBeanTotal.getWeight()) - Double.parseDouble(list[5]);
                ...
                tStockBean.setLocation_id(list[4]); //*** get Location_in form CS_049
                tStockBean.setDoc_type("+");
                ...
                if (whBean != null) {
                    ...
                    whData.setLocation_id(list[4]); //*** get Location_in form CS_049
                    whData.setProduct_id(list[2]);
                    double quant = Double.parseDouble(whBean.getWeight()) + Double.parseDouble(list[5]);
                    whData.setWeight(quant + "");
                    ...
                    whData.setLocation_id(list[4]); //*** get Location_in form CS_049
                    whData.setProduct_id(list[2]);
                    double quant = Double.parseDouble(list[5]);
                    whData.setWeight(quant + "");
                    double price_ = Double.parseDouble(price_t) * quant;
                    double total = new CostCal().calCostWh_Price(price_, quant);
                    whData.setPrice(df.format(total) + "");
