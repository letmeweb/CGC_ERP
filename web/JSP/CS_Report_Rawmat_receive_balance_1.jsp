<%@page import="com.cgc.report.PrintReport_Rawmat_receive_balance_1"%>
<%@page import ="com.cgc.Util.ThaiUtil" %>
<%@page language="java" contentType="text/html; charset=TIS-620" pageEncoding="TIS-620"%>

<%
PrintReport_Rawmat_receive_balance_1 objdetail = new PrintReport_Rawmat_receive_balance_1();
