...
<%!    UtiDatabase uti = new UtiDatabase();
    ...
    D_product_receive_header_whDAO obj_approve;
%>
<%
            userbean = (UserBean) session.getAttribute("user");
            obj_approve = new D_product_receive_header_whDAO();
            strsprit_runno = request.getParameter("line_no").split(",");
            strsprit_doc_id = request.getParameter("doc_id").split(",");
%>
<%=obj_approve.Cal_Approve(strsprit_runno, strsprit_doc_id,userbean.getUsername())%>
