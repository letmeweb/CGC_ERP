...
<html>
    ...
    <%        lookup = (String) request.getParameter("lookup");
        ...
        String inputSQL = " select create_date From vt_transaction_stock_process_report where process_id = 'PR_022' order by runno desc limit 1 ";
        String Last_Process_Time = objuti.Last_Create_Date2(inputSQL);
        System.out.println("Last_Process_Time = " + Last_Process_Time);
        Random r = new Random();
    ...
    <body onload="addDate();
        ...
        <input type="hidden" id="process_for" name="process_for" value="RAWMAT">            
        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>ประมวลผลข้อมูลวัตถุดิบ (CS_PROCESS_TRANSACTION_RAWMAT)</b>
                </div>                
