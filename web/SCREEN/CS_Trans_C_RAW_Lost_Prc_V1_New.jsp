        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <%
                ...
                if (!date_f.equals("") && !date_t.equals("") && !date_f.equals(null) && !date_t.equals(null)) {
                    sql_where1 = " WHERE to_date(format_date(doc_date),'YYYY-MM-DD') between to_date(format_date2('"
                ...
                //16-06-2016 String sql_product_id = " Select distinct(position_no) as location_id from " + table_rawmatt_receive + sql_where + " Order By position_no";
                
                String sql_product_id = " Select distinct(position_no) as location_id,(select runno"
                        + " from mlocation where location_id = position_no ) as order_location from " 
                        + table_rawmatt_receive + sql_where + " Order By order_location";
                ...
                //String sql_raw1 = " Select distinct(position_no) as location_id,wh_in,product_id from " + table_rawmatt_receive + sql_where1 + " Order By position_no";
                
                String sql_raw1 = " Select distinct(position_no) as location_id,wh_in,product_id ,(select runno"
                        + " from mlocation where location_id = position_no ) as order_location from " 
                        + table_rawmatt_receive + sql_where + " Order By order_location";                
                
                STateMent1 = Conn.createStatement();
                ResultSet rec_raw1 = STateMent.executeQuery(sql_raw1);
                System.out.println("sql_raw1  = " + sql_raw1);
                while (rec_raw1 != null && (rec_raw1.next())) {

                    String SqlIns_Tmp_Rawmat1 = "INSERT INTO tmp_rawmat_lost_summary(pgroup_id,doc_date,product_id,doc_type,location_id"
                            + ",friction_dust_weight,pan_dust_weight,sucker_dust_weight"
                            + ",magnet1,magnet2,total_magnet,total_friction_weight,total_dust_weight,friction_total_weight"
                            + ") VALUES " + "('" + pgroup_id + "'"
                            + ",'" + doc_date + "'"
                            + ",'" + rec_raw1.getString("product_id") + "'"
                            + ",'" + rec_raw1.getString("wh_in") + "'"
                            + ",'" + rec_raw1.getString("location_id") + "'"
                            + ",'0'"
                            + ",'0'"
                            + ",'0'"
                            + ",'0'"
                            ...
                            + ",'0'"
                            + ")";
                    System.out.println("SqlIns_Tmp_Rawmat1  = " + SqlIns_Tmp_Rawmat1);
                    STateMentData1 = Conn.createStatement();
                    STateMentData1.execute(SqlIns_Tmp_Rawmat1);
                }
                ...
                while (rec_raw_friction != null && (rec_raw_friction.next())) {
                    ...
                    System.out.println("friction_total_weight = " + friction_total_weight);
                    SqlUpdate_Tmp_Rawmat = " Update tmp_rawmat_lost_summary set friction_dust_weight = " + rec_raw_friction.getString("sum_friction_dust_weight")
                            + ",pan_dust_weight = " + rec_raw_friction.getString("sum_pan_dust_weight")
                            + ",sucker_dust_weight = " + rec_raw_friction.getString("sum_sucker_dust_weight")
                            + ",magnet1 = " + rec_raw_friction.getString("sum_magnet1")
                            + ",magnet2 = " + rec_raw_friction.getString("sum_magnet2")
                            + ",total_magnet = " + rec_raw_friction.getString("total_magnet")
                            + ",total_friction_weight = " + rec_raw_friction.getString("laps_total_weight")
                            + ",total_dust_weight = " + rec_raw_friction.getString("total_dust_weight")
                            + ",friction_total_weight = " + friction_total_weight
                            + " where location_id = '" + rec_raw_friction.getString("location_id") + "'"
                            + " and product_id = '" + rec_raw_friction.getString("product_id") + "'";
                ...
                while (rec_raw_lost_location != null && (rec_raw_lost_location.next())) {
                    ...
                    sql_raw_receive = " Select position_no,pgroup_id,ptype_id,product_id "
                            ...
                            + sql_where
                            + " and position_no = '" + rec_raw_lost_location.getString("location_id") + "'"
                            + " and pgroup_id <> '' "
                    ...
                    while (rec_raw_receive != null && (rec_raw_receive.next())) {
                        ...
                        String sql_friction_withdraw = " Select location_id,pgroup_id,product_id "
                                ...
                                + sql_where
                                + " and location_id = '" + rec_raw_lost_location.getString("location_id") + "'"
                        ...
                        String sql_bigbag_receive = " Select location_id2,pgroup_id,product_id "
                                ...
                                + sql_where
                                + " and location_id2 = '" + rec_raw_lost_location.getString("location_id") + "'"
