        ...
        <script type="text/javascript">
            ...
            function goGenDoc_id(doc_date_val)
            {
                if (document.getElementById('doc_date').value === '' || document.getElementById('doc_time').value === '') {
                    alertify.alert('กรุณาใส่ข้อมูลวันที่เอกสารและเวลา');
                }
                else {
            ...
            function AddHeader()
            {
                if (getId('doc_id').value === '') {
                    ...
                    alertify.confirm("ต้องการบันทึกข้อมูลหรือไม่ ?", function(e) {
                        if (e)
                        {
                            getSave_1(URLsend('complete_flag,chkNull,doc_id,doc_date,date_ck,status_cancle,child_ck,doc_time,wh_in,wh_out,runner_id,p_type,remark,username,rawmat_emp,rawmat_emp_name', '../JSP/CS_057.jsp'));
                            getId("status_cancle").value = "";
                            getId("child_ck").value = "";
                            getId("show").innerHTML = "";
                            getId("doc_id").disabled = false;
            ...
            function Delete()
            {
                alertify.confirm("ต้องการลบข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('complete_flag,doc_id,doc_date,status_cancle,date_ck,child_ck,doc_time,wh_in,wh_out,runner_id,runner_id_desc,p_type,remark,status_d,username,rawmat_emp,rawmat_emp_name', '../JSP/CS_057.jsp'));
                        getId("status_cancle").value = "";
                        getId("child_ck").value = "";
                        getId("show").innerHTML = "";
                        getId("doc_id").disabled = false;
            ...
            function Unload()
            {
                ...
                if (getId("doc_id").disabled === true && getId("status_cancle").value !== "1") {
                    ...
                    if (r === true) {
                        getSave_1(URLsend('chkNull,doc_id,doc_date,status_cancle,doc_time,wh_in,wh_out,runner_id,runner_id_desc,p_type,p_type_desc,remark,username,rawmat_emp,rawmat_emp_name', '../JSP/CS_057.jsp'));
                    }
                    else {
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        <!--a href='#' onClick="javascript:openBrWindow('Vemployee&stadment=and+emp_id+between+\'0001\'+and+\'0008\'', 23, 'Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' class="inputs" name='runner_id_desc' id="runner_id_desc" size='30' value='' readonly="readonly"/-->
                                        <a href='#' onClick="javascript:openBrWindow('Vemployee&stadment=and+dept_id+=+\'10\'or+dept_id+=+\'09\'or+dept_id+=+\'30\'', 23, 'Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' class="inputs" name='runner_id_desc' id="runner_id_desc" size='30' value='' readonly="readonly"/>
                                    </td>
                                </tr>
                                <tr>
