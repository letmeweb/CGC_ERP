...
<html>
    ...
    <body>
        ...
        <h2><center>Return Document คืนเอกสารการเบิกถ่านวัตถุดิบเพื่อสี</center></h2>
        ...
        // Note: this is set up to look in the same directory as the jsp file.
            String fileName = "data_rawmat_withdraw.txt";
        ...
        // 'application' is a freebie from the parent servlet.
                ...
                while (line != null) {
                    out.println("update d_rawmatt_withdraw_header set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("update d_rawmatt_withdraw_detail set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
        %>
        <%
                    line = br.readLine();
