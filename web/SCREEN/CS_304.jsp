    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cancle()
            {
                ...
                if (r)
                {
                    ...
                    else if (getId("status_cancle").value === "1" && getId("child_ck").value === "1")
                    {
                        ...
                        SURL = "../JSP/CS_305.jsp?status_d=3&chk_all=1";
            ...
            function goDelChild()
            {
                ...
                {
                    SURL = "../JSP/CS_305.jsp?status_d=3&chk_all=1&username=" + getId("username").value;
                    SURL = SURL + "&doc_id=" + getId("doc_id").value;
                    //alert(SURL);
                    Delete_Line_no(SURL);
                    showTableNonPopup("show", "doc_id", "../JSP/CS_Show305.jsp?doc_id=");
                    getId("chk_all").checked = false;
                }
                else//จะทำการลบข้อมูลเฉพาะ Datail ที่ทำการเลือกไว้
                {
                    SURL = "../JSP/CS_305.jsp?status_d=3&ckbox=";
                    ...
                    Delete_Line_no(SURL);
                    showTableNonPopup("show", "doc_id", "../JSP/CS_Show305.jsp?doc_id=");
                    setTimeout('showTableNonPopup("show", "doc_id", "../JSP/CS_Show305.jsp?doc_id=")', 100);
                }
            }
            ...
            function AddHeader()
            {
                ...
                if (r)
                {
                    getSave(URLsend('chkNull,doc_id,doc_date,doc_time,prd_emp_id,sending_id,remark,username,wh_emp_id,return_complete_flag,document_confirm_flag', '../JSP/CS_304.jsp'));
                    getId("show").innerHTML = "";
                    getId("status_cancle").value = "";
                    getId("child_ck").value = "";
                    getId("doc_id").disabled = false;
            ...
            function Delete()
            {
                ...
                if (r)
                {
                    getSave(URLsend('doc_id,doc_date,doc_time,prd_emp_id,sending_id,remark,status_d,username,wh_emp_id', '../JSP/CS_304.jsp'));
                    getId("show").innerHTML = "";
                    getId("status_cancle").value = "";
                    getId("child_ck").value = "";
                    getId("doc_id").disabled = false;
    ...
    <body onUnload="closepopup()">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "CS_304");
...
%>
            ...
            <input type="hidden" id="chkNull" value="doc_id,doc_date,doc_time,prd_emp_id,sending_id,wh_emp_id">
                ...
                <div class="container">
                    <div class="panel panel-primary">
                        <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                            <b>ใบแจ้งคืนถ่านกัมมันต์ที่เหลือจากการผลิตเข้าคลังสินค้า(คลังสินค้า)(CS_304)</b>
                        </div>                        
                            ...
                            <div align="center">                    
                                <table width="94%"  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="600" class="columnobject"><input name='doc_id' type='text' class="inputs" id="doc_id" value='' size='10' readonly/>
                                            &nbsp;
                                            <a href='javascript:;' onClick="openBrWindow('vd_carbon_return_header_wh&stadment=and+complete_flag+=+\'N\'+and+doc_type+=+\'N\'', 304, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
                                            <a href='javascript:;' onClick="openBrWindow('vd_carbon_return_header_wh&stadment=and+complete_flag+=+\'N\'+and+doc_type+=+\'Y\'', 304, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
                                            วันที่เอกสาร*&nbsp;
                                                ...
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td colspan="9" class="btn_multi">
                                                            <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,status_a,username', 'CS_305.jsp'));"/>
                                    ...
                                    <tr>
                                        <td colspan="2" align="center"><div align="right"><span class="columnobject">ผู้รับคืน*
                                                    <input name='wh_emp_id' type='text' class="inputs" id="wh_emp_id" value='' size='10'readonly />
                                                    &nbsp;<a href='javascript:;' onClick="openBrWindow('Vemployee', 103, 'Search_Config2.jsp')" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                                    <input name='wh_emp_id_desc' type='text' class="inputs" id="wh_emp_id_desc" value='' size='20' readonly/>
                                                    &nbsp;&nbsp;&nbsp;ผู้นำส่ง*
                                                    ...
                                                    <input name='sending_id_desc' type='text' class="inputs" id="sending_id_desc" value='' size='20' readonly/>
                                                    &nbsp;&nbsp;</span></div></td>
                                    </tr>
                                    <tr>
