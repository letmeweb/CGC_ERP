...
<html>
    ...
    <body onUnload="closepopup()">
        ...
        <input type="hidden" id="chkNull" name="chkNull" value="process_id,date_from,date_to">
        <form name="exportfile" method="post" action="../JSP/CS_Print_Summary_Warehouse.jsp" >
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td width="158" class='columnlabel'>รหัสprocess*</td>
                                    <td colspan="3" class='columnobject'><input type='text' class="inputs" name='process_id' id="process_id" size='10' value='' />
                                            &nbsp;<a href='javascript:;' onClick="openBrWindow('vmprocess', 482, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type='text' class="inputs" name='process_name' id="process_name" size='30' value='' /></td>
                              </tr>
                                <tr>
                                    <td class='columnlabel'>วันที่เอกสารเริ่มต้น&nbsp;</td><td width="182" class='columnobject'><input name='date_from' type='text' class="inputs" id="date_from" value='' size="20" />
