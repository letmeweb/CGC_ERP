                                ...
                                <table width="94%"  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                      ...
                                      <td width="600" class="columnobject">
                                            ...
                                            &nbsp;<a href="javascript:;" id='date_1'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.png' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'doc_date',ifFormat:'%Y-%m-%d',showsTime:false,button:'date_1',singleClick:true,step:1});</script>&nbsp;&nbsp;                                        </td>
                                    </tr>
                                        ...
                                        <td colspan="2" align="center">
                                          <div>
                                            <table width="200" border="0" cellpadding="0" cellspacing="1">
                                              <tr>
                                              <td colspan="5" class="h_multi">
                                                            <div align="right">
                                                                <input type='button' name='but1' value='  เพิ่ม  '/>
                                                                <input type='button' name='but2' value='  ลบ  '/>
                                                            </div></td>
                                              </tr>
                                              <tr>
                                                <td class="row3"><div align="center">รหัส</div></td>
                                                <td class="row3"><div align="center">จำนวน / kg</div></td>
                                                <td class="row3"><div align="center">คลังสินค้า</div></td>
                                                <td class="row3"><div align="center">จากกองที่</div></td>
                                                <td class="row3"><div align="center">รับกองที่</div></td>
                                              </tr>
                                            </table>
                                          </div>
