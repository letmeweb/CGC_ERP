...
<%@page import="com.cgc.DB.D_carbon_burn_in_detail_whDAO"%>
...
<html>
    ...
    <body onLoad="select()" >
        <%!
            ...
            D_carbon_burn_in_detail_whDAO objDAO = new D_carbon_burn_in_detail_whDAO();
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='tank_suite' type='text' class="inputs" id="tank_suite" value='<%=tank_suite%>' size='10' />                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><span class="columnlabel1">
                                        <input name="channel" type='text' class="inputs" id="channel" size="10" value="<%=channel%>">
                                    </span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='silo_no' type='text' class="inputs" id="silo_no" value='<%=silo_no%>' size='10' readonly/> <a href='#' onClick="openBrWindow('Warehouse', 28, 'Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>                              <input name='silo_desc' type='hidden' id="silo_desc" value='' size='30' />  </td>
                            </tr>
                            <tr>
                                <td class="columnlabel1">น้ำหนักถัง+ถ่าน* :&nbsp;</td>
                                <td class="columnobject">

                                    <input name='weight_tot' type='text' class="inputs" id="weight_tot" onBlur="CalChang();" onKeyUp="IsNuber(this.value, this)" value='<%=weight_tot%>' size='10'/>                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel1">น้ำหนักถัง* :&nbsp;</td>
                                <td class="columnobject">

                                    <input name='weight_tank' type='text' class="inputs" id="weight_tank"  onblur="CalChang()" onKeyUp="IsNuber(this.value, this)" value='<%=weight_tank%>' size='10'/>                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel1">น้ำหนักถ่าน* :&nbsp;</td>
                                <td class="columnobject"><input name='weight' type='text' class="inputs" id="weight"  value='<%=weight%>' size='10' readonly="readonly"/></td>
                            </tr>
                            <tr>
