...
<html>
    ...
    <script type="text/javascript">
        ...
        function goAdd()
        {
            ...
            {
                getSave(URLsend('doc_id,prd_no,size,c_type,iod,comp_palate,late_no,machine,size_cont,bag,s_weight,weight,reason_ret,remark,status_a,username', '../JSP/CS_305.jsp'));
                opener.getId("child_ck").value = "1";
                //opener.getId("doc_id").disabled = true;
                showTable("show", "doc_id", "../JSP/CS_Show305.jsp?doc_id=");
                setTimeout('showTable("show","doc_id","../JSP/CS_Show305.jsp?doc_id=")', 1000);
        ...
        function goEdit()
        {
            ...
            if (ChkParameter(arrayChk))
            {
                getSave(URLsend('doc_id,line_no,prd_no,size,c_type,iod,comp_palate,late_no,machine,size_cont,bag,s_weight,weight,reason_ret,remark,status_u,username', '../JSP/CS_305.jsp'));
                //opener.getId("doc_id").disabled = true;
                showTable("show", "doc_id", "../JSP/CS_Show305.jsp?doc_id=");
                setTimeout('showTable("show","doc_id","../JSP/CS_Show305.jsp?doc_id=")', 1000);
                setTimeout('window.close()', 1000);
...
<body>
    <%!            ThaiUtil en = new ThaiUtil();
        D_carbon_return_detail_whDAO objDAO = new D_carbon_return_detail_whDAO();
                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="size" type='text' class="inputs" id="size" size="10" value="<%=size%>"></td>
                            </tr>
                            <tr>
                                ...
                                <td class="columnobject"><input name="c_type" type='text' class="inputs" id="c_type" size="10" value="<%=c_type%>">
                                    <a href='#' onclick="javascript:openBrWindow('Mproduct_cat', 108, 'Search_Config2.jsp');" >
                                        <img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle'  ></a>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name="iod" type='text' class="inputs" id="iod" size="20" value="<%=iod%>"  readonly>
