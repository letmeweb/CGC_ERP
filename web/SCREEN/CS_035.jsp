    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd()
            {
                ...
                {
                    getSave_1(URLsend('doc_id,pcat_id,size_use,grd_io_ctc,weight,machine,job_id,remark,doc_date,status_a,username,bag,palate_no,product_id', '../JSP/CS_035.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave_1(URLsend('doc_id,pcat_id,size_use,grd_io_ctc,weight,machine,job_id,remark,doc_date,line_no,status_u,username,bag,palate_no,product_id', '../JSP/CS_035.jsp'));
            ...
            function Checkvalue_document_confirm(objthis) {
                if (objthis.checked) {
                    objthis.value = "Y";
                    getId("job_id").value = "STOCK-WH";
                    getId("job_id_desc").value = "STOCK คลังสินค้า";
                } else {
                    objthis.value = "N";
                    getId("job_id").value = "";
                    getId("job_id_desc").value = "";
                }
                //alert(objthis.value);
            }
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    <a href='#' onClick="javascript:openBrWindow('Vd_job_order_header', 35, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE2' width='20' height='20' border='0' align='middle' ></a>
