        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> 
                    <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp; <b>รายงานความเคลื่อนไหวถ่านวัตถุดิบ (CS_Trans_C_RAW_Scr_V1)</b>
                </div>                

                <div class="panel-footer">

                    <form name ="report" action="CS_Trans_C_RAW_Prc_V1.jsp" target="_blank" method ="post">
