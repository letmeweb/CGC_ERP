    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd() {
                ...
                {
                    getSave_1(URLsend('doc_id,line_no,tank_suite,product_id,location_id,silo_no,weight_tot,weight_tank,weight,status_a,username,channel,remark', '../JSP/CS_028.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    getSave_1(URLsend('doc_id,line_no,tank_suite,product_id,location_id,silo_no,weight_tot,weight_tank,weight,status_u,username,channel,remark', '../JSP/CS_028.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show028.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show028.jsp?doc_id=");', 800);
                    setTimeout('window.close()', 1000);
