...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                {
                    getSave_1(URLsend('doc_id,bag,prd_place,c_type,prd_code,h2o,ba,iod,hd1,hd2,hd3,hd4,hd5,hd6,hd7,hd8,hd9,hd10,hd11,hd12,hd13,hd14,hd15,remark,status_a,username,job_id', '../JSP/CS_109.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave_1(URLsend('doc_id,bag,prd_place,c_type,prd_code,h2o,ba,iod,hd1,hd2,hd3,hd4,hd5,hd6,hd7,hd8,hd9,hd10,hd11,hd12,hd13,hd14,hd15,remark,header_id,status_u,username,job_id', '../JSP/CS_109.jsp'));
                    //opener.getId("doc_id").disabled = true;
                    opener.getId("doc_id").disabled = false;
                    //showTable("show","doc_id","../JSP/CS_Show109.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show109.jsp?doc_id=")', 1000);
    ...
    <body >
        ...
        <input name="job_id_desc" type="hidden" id="job_id_desc" value ="<%=job_id_desc%>"size="30">        
                    ...
                    <div class="panel-footer">                      
                        ...
                        <div align="center">     
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td height="51" class="columnlabel1">&nbsp;</td>
                                    <td colspan="15" class="columnobject"  >
                                        <table width="100%" border="0" id="tbExp">
                                            ...
                                            <tr>
                                                ...
                                                <td class="row3" width='5%'><input name="hd1" type='text'  id="hd1" size="4" value="<%=hd1%>"></td>
                                                <td class="row3" width='5%'><input name="hd2" type='text'  id="hd2" size="4" value="<%=hd2%>"></td>
                                                <td class="row3" width='5%'><input name="hd3" type='text'  id="hd3" size="4" value="<%=hd3%>"></td>
                                                <td class="row3" width='5%'><input name="hd4" type='text'  id="hd4" size="4" value="<%=hd4%>"></td>
                                                <td class="row3" width='5%'><input name="hd5" type='text'  id="hd5" size="4" value="<%=hd5%>"></td>
                                                <td class="row3" width='5%'><input name="hd6" type='text'  id="hd6" size="4" value="<%=hd6%>"></td>
                                                <td class="row3" width='5%'><input name="hd7" type='text'  id="hd7" size="4" value="<%=hd7%>"></td>
                                                <td class="row3" width='5%'><input name="hd8" type='text'  id="hd8" size="4" value="<%=hd8%>"></td>
                                                <td class="row3" width='5%'><input name="hd9" type='text'  id="hd9" size="4" value="<%=hd9%>"></td>
                                                <td class="row3" width='5%'><input name="hd10" type='text'  id="hd10" size="4" value="<%=hd10%>"></td>
                                                <td class="row3" width='5%'><input name="hd11" type='text'  id="hd11" size="4" value="<%=hd11%>"></td>
                                                <td class="row3" width='5%'><input name="hd12" type='text'  id="hd12" size="4" value="<%=hd12%>"></td>
                                                <td class="row3" width='5%'><input name="hd13" type='text'  id="hd13" size="4" value="<%=hd13%>"></td>
                                                <td class="row3" width='5%'><input name="hd14" type='text'  id="hd14" size="4" value="<%=hd14%>"></td>
                                                <td class="row3" width='5%'><input name="hd15" type='text'  id="hd15" size="4" value="<%=hd15%>"></td>
