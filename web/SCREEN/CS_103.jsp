    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function Record_Count() {
                AjaxRun_id("record_count1", "../JSP/CS_D_WH_Count_Doc.jsp?runer_id=6");
            }
    ...
    <body onload="Start_Check_Record_Count();">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">   
            <%
                ...
                String inputSQL = " select count(*) as num from vd_carbon_return_header where complete_flag <> 'Y' and  count_send_complete <> '0'   ";
