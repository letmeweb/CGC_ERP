    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave_1(URLsend('doc_id,wh_id,product_id,size,i2,bag,weight,remark,status_a,username,product_no,weight_unit,pack_repacking_status,carbon_trap_status,doc_type', '../JSP/CS_044_1.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave_1(URLsend('doc_id,line_no,wh_id,product_id,size,i2,bag,weight,remark,status_u,username,product_no,weight_unit,pack_repacking_status,carbon_trap_status,doc_type', '../JSP/CS_044_1.jsp'));
                    showTable("show2", "doc_id", "../JSP/CS_Show044_1.jsp?doc_id=");
                    setTimeout('showTable("show2","doc_id","../JSP/CS_Show044_1.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1000);
                }
