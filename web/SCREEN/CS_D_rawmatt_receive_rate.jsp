                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><input name='supplier_id' type='text' class="inputs" id="supplier_id" value='' size='20'  />                                        
                                            &nbsp;<a href='javascript:;' onClick="openBrWindow('v_rawmatt_receive_supplier', 24, 'Search_Config_rawmat_supplier.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหาข้อมูลที่ยังไม่ได้อนุมัติ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
