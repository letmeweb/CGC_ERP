    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                {
                    getSave_1(URLsend('chkNull,doc_id,header_id,bag,prd_place,c_type,prd_code,h2o,ba,iod,hd1,hd2,hd3,hd4,hd5,hd6,hd7,hd8,hd9,hd10,hd11,hd12,hd13,hd14,hd15,valuepass,grade,remark,status_a,username,job_id', '../JSP/CS_Parameter109.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    getSave_1(URLsend('chkNull,doc_id,bag,prd_place,c_type,prd_code,h2o,ba,iod,hd1,hd2,hd3,hd4,hd5,hd6,hd7,hd8,hd9,hd10,hd11,hd12,hd13,hd14,hd15,valuepass,grade,remark,status_u,username,line_no,header_id,job_id', '../JSP/CS_Parameter109.jsp'));
                    window.opener.location.reload();
                    setTimeout('window.close()', 1000);
                }
            }
