...
//                    alertify.alert("Delete ALL");
            ...
            function AddHeader()
            {
                alertify.confirm("ต้องการบันทึกข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        var arryChk = new Array;
                        arryChk[0] = "chkNull";
                        //if (ChkParameter_1(arryChk) && check_detail_null()) {                        
                        if (ChkParameter_1(arryChk)) {
                            var strID = "";
                            var select_id = "";
                            ...
                            getSave_1(URLsend('chkNull,maxline,' + strID, '../JSP/CS_D_carbon_send_product_header_analyze.jsp'));
                            ResetValue();
                        }
                    }
                });
            ...
            function Delete()
            {
                alertify.confirm("ต้องการลบข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('D_status,A_doc_id', '../JSP/CS_D_carbon_send_product_header_analyze.jsp'));
                        ResetValue();
                    }
                });
            ...
            function Check_Confirm(This, Id_texbox) {
                ...
                //alertify.alert(getId(This.id).checked);
                if (getId("emp_id").value === getId(Id_texbox).value) {
                    if (getId(This.id).checked) {
                        ...
                        //alertify.alert(getId(This.id).value);
                    } else {
