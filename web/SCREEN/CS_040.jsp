        ...
        <script type="text/javascript">
            ...
            function AddHeader()
            {
                alertify.confirm("ต้องการบันทึกข้อมูลหรือไม่ ?", function(e) {
                    ...
                    {
                        //alert("test")
                        getSave_1(URLsend('chkNull,doc_id,doc_date,job_id,job_id_desc,time_from,time_to,emp_id,emp_id_desc,shift,wh_in,wh_out,lost_weight,total_bag_withdraw,total_weight_withdraw,total_bag,total_weight,username,runner_id,complete_flag,sum_pack_month,sum_pack_year', '../JSP/CS_040.jsp'));
                        getId("doc_id").disabled = false;
            ...
            function Delete()
            {
                alertify.confirm("ต้องการลบข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('doc_id,doc_date,job_id,job_id_desc,time_from,time_to,emp_id,emp_id_desc,shift,wh_in,wh_out,lost_weight,total_bag_withdraw,total_weight_withdraw,total_bag,total_weight,status_d,username,runner_id', '../JSP/CS_040.jsp'));
                        getId("doc_id").disabled = false;
                        getId("show").innerHTML = "";
                        getId("show2").innerHTML = "";
                        getId("status_cancle").value = "";
