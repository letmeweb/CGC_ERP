                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="607" class="columnobject">
                                        ...
                                        &nbsp;<a href='#' onClick="javascript:openBrWindow('vd_ticketbuy_doc_not_cgc&stadment=and+complete_flag+<>+\'Y\'', 115, 'Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        <b>วันที่เอกสาร* :</b>&nbsp;
                                ...
                                <tr>
                                    <td width="150" class="columnlabel1"><b>เอกสารที่อนุมัติแล้ว :</b>&nbsp;</td>
                                    <td width="607" class="columnobject">                                        
                                        <a href='#' onClick="javascript:openBrWindow('vd_ticketbuy_doc_not_cgc&stadment=and+complete_flag+=+\'Y\'', 115, 'Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;                                                                                
                                    </td>
                                            ...
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <!--tr>
                                                    ...
                                                    <td colspan="6" class="btn_multi">
                                                        <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,doc_date,status_a,username', 'CS_D_ticketbuy_doc_1.jsp'))"/>
                                                        <input type='button' class="cgcButton_3" name='but2' value='  ลบ  ' onclick='goDelChild()'/>
                                                    </td>
                                                </tr-->
                                                <tr>
                                                    <td class="headergrid" colspan="17">ข้อมูลการรับไม้ฟืน</td>
                                                </tr>                                                
                                            </table>
                                        </div>
