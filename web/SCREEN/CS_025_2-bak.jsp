                                                    ...
                                                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                        <tr>
                                                            ...
                                                            <td colspan="7" class="btn_multi">
                                                                <input type='button' class="cgcButton_4" name='but1' value='   เพิ่ม   ' onClick="(getId('doc_id').value === '') ? alert('กรุณาเลือกรหัสเอกสารก่อน') : goAddChild(URLsend('doc_id,doc_date,shift,username,status_a', 'CS_Detail_025_1.jsp'));"/>
                                                                <!--input type='button' class="cgcButton_4" name='but1' value='   เพิ่ม   ' onClick="goAddChild(URLsend('doc_id,doc_date,shift,username,status_a', 'CS_Detail_025_1.jsp'));"/-->
