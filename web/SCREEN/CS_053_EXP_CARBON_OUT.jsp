                    ...
                    <form name="exportfile" method="post" action="../JSP/CS_053_EXP_CARBON_OUT.jsp" >
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>                                
                                ...
                                <td class="columnobject"><input name="doc_year" type='text' class="inputs" id="doc_year" value="2557" size="10" data-toggle="tooltip" title="ปี พ.ศ.">                                        
                            </tr>                                 

                            <tr>
                                <td class='columnlabel1'>วันที่เริ่มต้น&nbsp;:&nbsp;</td><td width="182" class='columnobject'><input name='date_from' type='text' class="inputs" id="date_from" value='01-01-2557' size="15" />
                                ...
                                <td width="150" class='columnlabel1'><script type='text/javascript'>Calendar.setup({inputField: 'date_from', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_1', singleClick: true, step: 1});</script>
                                    วันที่สิ้นสุด&nbsp;:&nbsp;</td>
                                <td width="267" class='columnobject'><input name='date_to' type='text' class="inputs" id="date_to" value='31-12-2557' size="15" />
