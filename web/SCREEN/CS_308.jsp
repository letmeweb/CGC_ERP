    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave_1(URLsend('doc_id,wh_id,product_id,size,i2,bag,weight,remark,status_a,username,product_no,weight_unit', '../JSP/CS_308.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave_1(URLsend('doc_id,line_no,wh_id,product_id,size,i2,bag,weight,remark,status_u,username,product_no,weight_unit', '../JSP/CS_308.jsp'));
                    showTable("show2", "doc_id", "../JSP/CS_Show308.jsp?doc_id=");
                    setTimeout('showTable("show2","doc_id","../JSP/CS_Show308.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1000);
                }
                    ...
                    <div class="panel-footer">            
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <div class="checkbox checkbox-primary">
                                        <input name="pack_repacking_status" type="checkbox" id="pack_repacking_status" value="<%=pack_repacking_status%>" onClick="Chk_insert_value(this.name)" disabled>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <div class="checkbox checkbox-primary">
                                        <input name="carbon_trap_status" type="checkbox" id="carbon_trap_status" value="<%=carbon_trap_status%>" onClick="Chk_insert_value(this.name)" disabled>
