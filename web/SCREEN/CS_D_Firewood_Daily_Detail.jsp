                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input type='text' class="inputs" name='supplier_id' size='10' value='<%=supplier_id%>' id="supplier_id" readonly="readonly"/>
                                    ...
                                    <input type='text' class="inputs" name='supplier_id_desc' size='30' value='<%=supplier_name%>' id="supplier_id_desc" readonly="readonly"/>
                                    &nbsp;&nbsp;</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ทะเบียนรถ&nbsp;</td>
                                <td class="columnobject">
                                    <input type='text' class="inputs" name='car_no' size='10' value='<%=car_no%>' id="car_no"/>                                </td>
                            </tr>                            
                            <tr>
