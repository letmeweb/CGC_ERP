    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd()
            {
                ...
                {
                    getSave_1(URLsend('doc_id,doc_date,doc_type,product_id,location_id,weight,wh_in,status_a,username', '../JSP/CS_117_1.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    getSave_1(URLsend('doc_id,product_id,location_id,weight,wh_in,line_no,status_u,username', '../JSP/CS_117_1.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show117.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show117.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1500);
            ...
            function goDelete()
            {
                if (alertify.confirm("ต้องการลบข้อมูล ?")) {
