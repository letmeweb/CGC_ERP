            ...
            function AddHeader()
            {
                ...
                alertify.confirm("ต้องการบันทึกข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        ...
                        getSave_1(URLsend(strId, '../JSP/CS_032.jsp'));
                        setTimeout('showTableNonPopup("show", "doc_id", "../JSP/CS_Show032.jsp?doc_id=")', 1500);
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="607" class="columnobject">
                                        ...
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'and+doc_id+<>+\'STOCK-WH\'', 32, 'Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        <b>วันที่เอกสาร*</b>&nbsp;:&nbsp;
