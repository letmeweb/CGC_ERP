        ...
        <script type="text/javascript">
            ...
            function Delete()
            {
                ...
                alertify.confirm("คุณต้องการลบข้อมูลทั้งหมดหรือไม่ ?", function(e) {
                    if (e)
                    {
                        confirmDialogDelete_1(URLsend('status_d,runno', '../JSP/CS_059.jsp'));
                        ResetValue();
                    }
                });
            ...
            function OpenProduct_id(input)
            {
                switch (input) {
                    case 1:
                        //alertify.alert(getId("price_year").value);
                        if (getId("price_year").value !== "price_year") {
                            openBrWindow("vmrawmat_price&stadment=and+pgroup_id='RAW'+and+price_year+=+\'" + getId("price_year").value + "\'", 62, 'Search_ConfigProductPrice.jsp');
                        } else {
                            alertify.alert("กรุณาเลือกปี พ.ศ.");
                        }
                        break;
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    <div class="panel-heading"> <span class="glyphicon glyphicon-pencil" style="color:white"></span>&nbsp;
                        <b>บันทึกราคาต่อหน่วยวัตถุดิบ (CS_062)</b>
                    </div>                
                    ...
                    <div class="panel-footer">           
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td width="170" class="columnlabel1"><b>กลุ่มวัตถุดิบ&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">
                            ...
                            <tr>
                                <td class="columnlabel1"><b>รหัสวัตถุดิบ&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                  
                            ...
                            <tr>                                  
                                ...
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_1' type='text' class="inputs" id="price_month_1" value='' size='10' onblur="IsNuber(this.value, this)"/>
                                </td>
                            </tr> 
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 2&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_2' type='text' class="inputs" id="price_month_2" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>          
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 3&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_3' type='text' class="inputs" id="price_month_3" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr> 
                            <tr>                                  
                            ...
                            <tr>                                  
                                ...
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_5' type='text' class="inputs" id="price_month_5" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 6&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_6' type='text' class="inputs" id="price_month_6" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr> 
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 7&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_7' type='text' class="inputs" id="price_month_7" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 8&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_8' type='text' class="inputs" id="price_month_8" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>         
                            <tr>                                 
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 9&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_9' type='text' class="inputs" id="price_month_9" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 10&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_10' type='text' class="inputs" id="price_month_10" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>         
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 11&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_11' type='text' class="inputs" id="price_month_11" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>
                            <tr>                                  
                                <td class="columnlabel1"><b>ราคา/หน่วย เดือนที่ 12&nbsp;:&nbsp;</b></td>
                                <td colspan="3" class="columnobject">                                    
                                    <input name='price_month_12' type='text' class="inputs" id="price_month_12" value='' size='10' onblur="IsNuber(this.value, this)"/>                                       	          	
                                </td>
                            </tr>    
