                        ...
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <!--tr>
                                    ...
                                    <td class='columnobject'><input type='text' class="inputs" id="product_id" name="product_id" size="10"></td>
                                <tr-->
                                ...
                                <tr>
                                    <td colspan='4' class='blankspace' align="right">
                                        <input type="button" name="myBut" value=" Export Data  " onClick="Action_Export()"/>
                                        <input type="button" name="myBut" value=" ยกเลิก  " onClick="Cancelvalue()"/>                                       </td>
                                </tr>
                                <tr>
                                    <td colspan='4' class='blankspace' ></td>
                                </tr>
