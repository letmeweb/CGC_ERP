        ...
        <script type="text/javascript">
            ...
            function AddHeader()
            {
                alertify.confirm("ต้องการบันทึกข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('chkNull,doc_id,doc_date,doc_time,report_id,remark,shift,complete_flag', '../JSP/CS_025_2.jsp'));
                        getId("show").innerHTML = "";
                        getId("show2").innerHTML = "";
                        getId("show3").innerHTML = "";
                        getId("status_cancle").value = "";
            ...
            function Delete()
            {
                alertify.confirm("ต้องการลบข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('doc_id,doc_date,status_d,username', '../JSP/CS_025_2.jsp'));
                        getId("show").innerHTML = "";
                        getId("show2").innerHTML = "";
                        getId("show3").innerHTML = "";
                        getId("status_cancle").value = "";
    ...
    <body onload="Start_Check_Record_Count();">
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <%
                ...
                String inputSQL = " select count(*) as num from vd_carbon_friction_header where complete_flag <> 'Y' ";
                                                    ...
                                                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                        <tr>
                                                            ...
                                                            <td colspan="7" class="btn_multi">
                                                                <input type='button' class="cgcButton_4" name='but1' value='   เพิ่ม   ' onClick="(getId('status_cancle').value === '1') ? goAddChild(URLsend('doc_id,doc_date,shift,username,status_a', 'CS_Detail_025_1.jsp')) : alertify.alert('กรุณาเลือกรหัสเอกสารก่อน');"/>
                                            ...
                                            <div id="tabs-2" align="center"><div style="width:100%;">
                                                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                        <tr>
                                                            <td colspan="5" class="h_multi"></td>
                                                            <td colspan="7" class="btn_multi">                                                          
                                                                <input type='button' name='but1' class="cgcButton_4" value='   เพิ่ม   ' onClick="(getId('status_cancle').value === '1') ? goAddChild(URLsend('doc_id,doc_date,shift,username,status_a', 'CS_Detail_025_2.jsp')) : alertify.alert('กรุณาเลือกรหัสเอกสาร');"/>
                                            ...
                                            <div id="tabs-3" align="center"><div style="width:100%;">
                                                    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                        <tr>
                                                            <td colspan="5" class="h_multi"></td>
                                                            <td colspan="7" class="btn_multi">
                                                                <input type='button' class="cgcButton_4" name='but1' value='   เพิ่ม   ' onClick="(getId('status_cancle').value === '1') ? goAddChild(URLsend('doc_id,doc_date,username,status_a', 'CS_Detail_025_3.jsp')) : alertify.alert('กรุณาเลือกรหัสเอกสาร');"/>
