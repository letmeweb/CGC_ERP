    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cancle()
            {
                ...
                var SURL;
                var r = alertify.confirm("คุณต้องการยกเลิกข้อมูลทั้งหมดหรือไม่");
                {
            ...
            function AddHeader()
            {
                alertify.confirm("ต้องการบันทึกข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        ...
                        ;
                        getSave_1(URLsend('chkNull,doc_id,doc_date,car_no,c_type,sender_id,report_id,approve_id,approve_status,username,car_date_in,moisture_average', '../JSP/CS_046.jsp'));
                        getId("show").innerHTML = "";
                        getId("doc_id").disabled = false;
                    }
                });
            ...
            function Delete()
            {
                alertify.confirm("ต้องการลบข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('doc_id,doc_date,car_no,c_type,sender_id,report_id,approve_id,approve_status,status_d,username', '../JSP/CS_046.jsp'));
                        getId("show").innerHTML = "";
                        getId("doc_id").disabled = false;
                    }
                });
            ...
            function Unload()
            {
                ...
                if (getId("doc_id").disabled === true && getId("status_cancle").value !== "1") {
                    ...
                    if (r === true) {
                        getSave_1(URLsend('chkNull,doc_id,doc_date,car_no,c_type,sender_id,report_id,approve_id,approve_status,username', '../JSP/CS_046.jsp'));
                    }
                    else {
            ...
            function Cal_Moise_Avg()
            {
                if (getId("doc_id").value === '') {
                    alertify.alert("เลือกเลขที่เอกสาร");
                } else {
                    AjaxRun_id("moisture_average", "../JSP/CS_046.jsp?status_cal=" + getId("doc_id").value);
                }
            }
