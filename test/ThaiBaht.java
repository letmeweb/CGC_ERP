...
public final class ThaiBaht {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         System.out.println("Positive string value of 1.8 : " + new ThaiBaht().getText(1.8));
         */
        System.out.println("Positive string value of 5.00 : " + new ThaiBaht().getText(5.00));
        System.out.println("Positive string value of 155.00 : " + new ThaiBaht().getText("155.00"));
        System.out.println("Positive string value of 10 : " + new ThaiBaht().getText(10));
        System.out.println("Positive string value of 6.56625 : " + new ThaiBaht().getText(6.56625));
    }
