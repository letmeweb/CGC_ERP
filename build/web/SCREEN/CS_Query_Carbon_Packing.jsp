...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            //function get_search() {
            //showTableNonPopup("show1", "A_Delay_Date", "../JSP/MA_CS_Store_Transaction_Report.jsp?select_case=1&A_Delay_Date=");
            //showTableNonPopup("show2", "A_doc_id", "../JSP/MA_CS_Store_Transaction_Report.jsp?select_case=2&A_doc_id=");                
            //}

            function get_search_Multi_Param() {
                if (getId("A_part_id").value === '') {
                    alert("กรุณาเลือกรหัสพัสดุ/อะไหล่ !!!");
                } else {
                    //showTableNonPopup2("show1", "A_doc_date,A_Part_Group,A_part_id", "../JSP/MA_CS_Store_Transaction_Report.jsp?A_doc_date=" + getId("A_doc_date").value + "&A_Part_Group=" + getId("A_Part_Group").value);
                    showTableNonPopup2("show1", "A_doc_date,A_Part_Group,A_part_id", "../JSP/MA_CS_Store_Transaction_Report.jsp");
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="glyphicon glyphicon-search" style="color:white"></span>&nbsp;<b>คนหารายการความเคลื่อนไหวพัสดุ/อะไหล่ (MA_CS_Store_Transaction_Report)</b></div>
