        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>ประมวลผลรายงานสรุปยอดคงเหลือวัตถุดิบตามหมายเลขกอง (CS_Trans_RAW_BALANCE_Location_Scr_V1)</b>
                </div>
                <!--div class="jumbotron"-->

                <div class="panel-footer">

                    <form name ="report" action="CS_Trans_RAW_BALANCE_Location_Prc_V1.jsp" target="_blank" method ="post">
