...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cancle()
            {
                location.replace("CS_D_carbon_analysis_header3.jsp");
            }
            ...
            function OpenDoc_id(input)
            {
                switch (input) {
                    case 0:
                        openBrWindow('vd_carbon_analysis_all_header&stadment=and+doc_type+=+\'PO\'and+quality_confirm+=+\'N\'', 28, 'Search_Doc_id.jsp');
                        break;
                    case 1:
                        openBrWindow('vd_carbon_analysis_all_header&stadment=and+doc_type+=+\'PO\'and+quality_confirm+=+\'Y\'', 28, 'Search_Doc_id.jsp');
                        break;
                }
            }
    ...
    <body >
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "CS_D_carbon_analysis_header3");
                UtiDatabase objuti = new UtiDatabase();
                // _______________________________________________________________report
                DataBean_Screen_Report objr_p = new DataBean_Screen_Report();
                HeaderScreen_Report r_p = new HeaderScreen_Report();
                objr_p = r_p.Fn_Report(objr_p, "S359");
                path = objr_p.getPath();
...
%>
            ...
            <input type="hidden" name="A_dept_doc_id" id="A_dept_doc_id" value="PO">
            <input type="hidden" name="A_doc_type" id="A_doc_type" value="PO">
            ...
            <input type="hidden" id="A_screen_id" name="A_screen_id" value="CS_D_carbon_analysis_header3">
                ...
                <div class="container">
                    <div class="panel panel-primary">
                        <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                            <b>บันทึกรายการวิเคราะห์คุณภาพถ่าน(CS_D_carbon_analysis_header3)</b>
                        </div>                        
                            ...
                            <div align="center">    
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="607" class="columnobject">                                    
                                            <input name='A_job_type' type='text' class="inputs" id="A_job_type" value='อื่น ๆ' size='20' maxlength="50" readonly/>                                                                                 
                                            &nbsp;&nbsp;กะ - เวลา&nbsp;
                                            <input name='A_send_doc_time' type='text' class="inputs" id="A_send_doc_time" value='' size='20' maxlength="50" />                                                                                
                                        </td>
                                    </tr>                                
                                    <tr>
