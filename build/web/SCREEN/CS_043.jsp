...
<html>
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave_1(URLsend('doc_id,wh_in,wh_out,doc_date,product_id,weight,bag,lot_no,remark,status_a,username,quantity,job_id', '../JSP/CS_043.jsp'));
                    opener.getId("doc_id").disabled = false;
                    showTable("show", "doc_id", "../JSP/CS_Show043.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show043.jsp?doc_id=")', 800);
            ...
            function goEdit()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    getSave_1(URLsend('doc_id,wh_in,wh_out,doc_date,product_id,weight,bag,lot_no,remark,line_no,status_u,username,quantity,job_id', '../JSP/CS_043.jsp'));
    ...
    <body>
        <%!        ThaiUtil en = new ThaiUtil();
            D_requisition_product_detailDAO objDAO = new D_requisition_product_detailDAO();
        ...
        <input type="hidden" id="chkNull" value="product_id,weight,quantity,bag,lot_no,job_id">
        <br>
        <div align="left">
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    <a href='#' onClick="javascript:openBrWindow('Vproduct&&stadment=and+ptype_code+=+\'2\'', 43, 'Search_Config2.jsp')" >
                                        <img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                    <input name='product_id_desc' type='text' class="inputs" id="product_id_desc" value='<%=prod_name%>' size='30' readonly="readonly"/>                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='bag' type='text' class="inputs" id="bag" value='<%=bag%>' size='10' onKeyUp="IsNuber(this.value, this)" onBlur="Cal_Weight('bag', 'quantity', 'weight')"/>                                
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='lot_no' type='text' class="inputs" id="lot_no" value='<%=lot_no%>' size='10' />                                
                                </td>
                            </tr>
