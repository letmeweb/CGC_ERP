...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function get_search() {
                ...
                if (getId("price_year").value == "price_year" || getId("month_id").value == "month_id") {
                    ...
                    showTableNonPopup2("show1", "month_id,price_year,location_id", "../JSP/CS_Report_Rawmat_receive_balance_1.jsp?month_id=" + getId("month_id").value + "&price_year=" + getId("price_year").value + "&location_id=" + getId("location_id").value);
                }
            ...
            function send_print() {
                ...
                getId("report_code").value = "RP_015_3";
        ...
        <title>CS_Report_Rawmat_receive_balance_1</title>
    </head>
    <body>
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    <div class="panel-heading"> <span class="glyphicon glyphicon-search" style="color:white"></span>&nbsp;
                        <b>รายการสรุปการรับ-เบิก คงเหลือ ถ่านวัตถุดิบ (CS_Report_Rawmat_receive_balance_1)</b>
                    </div>                
                                    ...
                                    <td colspan="2" align="center">
                                        <div width="100%">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                <tr>
                                                    <td class="headergrid" colspan="14">รายการสรุป รับ - จ่าย - ยอดคงเหลือ ถ่านวัตถุดิบ</td>
                                                </tr>
                                            </table>
                                        </div>
