        ...
        <form id="report" name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2">ประมวลผลข้อมูลมูลค่าวัตถุดิบรายวัน (ถ่านสี)(CS_PROCESS_TRANSACTION_RAWMAT_FRICTION_SUMMARY)&nbsp;</td>
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td class='columnlabel'><b>วันที่เริ่มต้น</b></td><td class='columnobject'><input name='doc_date_from' type='text' class="inputs" id="doc_date_from" value = "" readonly/>
                                ...
                                <tr>
                                    <td colspan='2' class='blankspace' align="right">                                        
                                        ...
                                        <input type="button" class="cgcButton_19" value="พิมพ์รายงาน" onClick="send_print();"/>
                                    </td>
