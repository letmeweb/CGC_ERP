...
<html>
    ...
    <%        lookup = (String) request.getParameter("lookup");
        ...
        String Last_Process_Time = objuti.Last_Create_Date("tmp_stock_daily");
        Random r = new Random();
        ...
        <script>
            ...
            function Process_Progress() {
                ...
                if (getId("time_process").value === '11' && Count <= 5) {
                    ...
                    AjaxRun_id("report", "../JSP/Count_Stock_Daily_Rec.jsp?runer_id='" + getId("r_create").value + "-" + getId("doc_date_to").value.substring(0, 2) + "-WH'");
                }
            }
    ...
    <body onload="Start_Check_Process_Progress();">
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <input type="hidden" name="report_code" value="RP_VTMP_STOCK_DAILY">  
