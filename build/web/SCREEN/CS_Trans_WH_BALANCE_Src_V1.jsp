        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> 
                    <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp; <b>รายงานยอดคงเหลือสินค้า (CS_Trans_WH_BALANCE_Scr_V1)</b>
                </div>                

                <div class="panel-footer">

                    <form name ="report" action="CS_Trans_WH_BALANCE_Prc_V1.jsp" target="_blank" method ="post">
                        ...
                        <table  cellpadding="0"  cellspacing="0">                                                                                    
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="pgroup_id" type='text' class="inputs" id="pgroup_id" value="" size="20" readonly>&nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('mproduct_group', 21, 'Search_Config2.jsp')"  data-toggle="tooltip" title="กลุ่มสินค้า"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="name_t_pgroup" id="name_t_pgroup" value=""></td>
                            </tr>                                  
                            <tr>
                                <td class='columnobject'><div align="right"><b>รหัสสินค้า&nbsp;:</b>&nbsp;</div></td>
                                <td class="columnobject"><input name="product_id" type='text' class="inputs" id="product_id" value="" size="20" >&nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('Vproduct', 301, 'Search_Config2.jsp')" data-toggle="tooltip" title="รหัสสินค้า"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="product_id_desc" id="product_id_desc" value=""></td>
                            </tr>                                                                                                     
