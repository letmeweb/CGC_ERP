        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-log-in" style="color:white"></span>&nbsp;
                    <b>WAREHOUSE Transaction Export Data (CS_053_EXP_WAREHOUSE_TRANSACTION)</b>
                </div>                

                <div class="panel-footer">                

                    <form name="exportfile" method="post" action="../JSP/CS_053_EXP_WAREHOUSE_TRANSACTION.jsp" >
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td width="158" class='columnlabel1'>ชื่อข้อมูลที่ Export :&nbsp;</td><td colspan="3" class='columnobject'><input name='export_id' type='text' class="inputs" id="export_id" value='EXP014' size="20" />
                                    <input name='export_id_desc' type='text' class="inputs" id="export_id_desc" value='ข้อมูลความเคลื่อนไหวคลังสินค้า' size="30" />
                                </td>
                            </tr>
