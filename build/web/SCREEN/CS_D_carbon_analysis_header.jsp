...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cancle()
            {
                location.replace("CS_D_carbon_analysis_header.jsp");
            }
            ...
            function OpenDoc_id(input)
            {
                switch (input) {
                    case 0:
                        openBrWindow('vd_carbon_analysis_all_header&stadment=and+doc_type+=+\'PT\'and+quality_confirm+=+\'N\'', 28, 'Search_Doc_id.jsp');
                        break;
                    case 1:
                        openBrWindow('vd_carbon_analysis_all_header&stadment=and+doc_type+=+\'PT\'and+quality_confirm+=+\'Y\'', 28, 'Search_Doc_id.jsp');
                        break;
                }
            }
    ...
    <body >
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "CS_D_carbon_analysis_header");
                UtiDatabase objuti = new UtiDatabase();
                // _______________________________________________________________report
                DataBean_Screen_Report objr_p = new DataBean_Screen_Report();
                HeaderScreen_Report r_p = new HeaderScreen_Report();
                objr_p = r_p.Fn_Report(objr_p, "S357");
                path = objr_p.getPath();
...
%>
            ...
            <input type="hidden" id="A_screen_id" name="A_screen_id" value="CS_D_carbon_analysis_header">
                ...
                <div class="container">
                    <div class="panel panel-primary">
                        <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                            <b>CS_D_carbon_analysis_header(CS_D_carbon_analysis_header)</b>
                        </div>                        
