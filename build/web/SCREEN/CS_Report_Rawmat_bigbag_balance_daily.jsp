...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function get_search() {
                ...
                if (getId("price_year").value === "price_year" || getId("month_id").value === "month_id") {
                    ...
                    showTableNonPopup2("show1", "month_id,price_year,location_id", "../JSP/CS_Report_Rawmat_bigbag_balance_daily.jsp?month_id=" + getId("month_id").value + "&price_year=" + getId("price_year").value + "&location_id=" + getId("location_id").value);
                }
        ...
        <title>CS_Report_Rawmat_bigbag_balance_daily</title>
    </head>
    <body>
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    <div class="panel-heading"> <span class="glyphicon glyphicon-search" style="color:white"></span>&nbsp;
                        <b>รายการสรุปการรับ-เบิก คงเหลือ วัตถุดิบถุงใหญ่ รายวัน (CS_Report_Rawmat_bigbag_balance_daily)</b>
                    </div>
