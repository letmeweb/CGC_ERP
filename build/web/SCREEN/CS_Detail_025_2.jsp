        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                if (parseInt(getId('rs_txtForSave').value) === 1) {
                    ...
                    {
                        getSave_1(URLsend('chkNull,doc_id,doc_date,product_id,friction_house,silo_no,location_id,balance_weight,remain_weight,status_a', '../JSP/CS_Detail_025_2.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    getSave_1(URLsend('chkNull,doc_id,doc_date,line_no,product_id,friction_house,silo_no,location_id,balance_weight,remain_weight,status_u', '../JSP/CS_Detail_025_2.jsp'));
                    showTable("show2", "doc_id", "../JSP/CS_DetailShow_025_2.jsp?doc_id=");
                    setTimeout('showTable("show2","doc_id","../JSP/CS_DetailShow_025_2.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 2000);
                }
