        ...
        <%
            ...
            try {
                ...
                while (line != null) {
                    ...
                    out.println("<BR>");
                    out.println("update d_rawmatt_analyze_header set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("update d_rawmatt_analyze_detail set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
        %>
        <%
                    line = br.readLine();
