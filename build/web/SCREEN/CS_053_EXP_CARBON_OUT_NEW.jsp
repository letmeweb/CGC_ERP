        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-log-in" style="color:white"></span>&nbsp;
                    <b>รายงานสรุปถ่านออกจากเตา (CS_053_EXP_CARBON_OUT_NEW)</b>
                </div>                

                <div class="panel-footer">        

                    <form name="exportfile" method="post" action="../JSP/CS_053_EXP_CARBON_OUT_NEW.jsp" >
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td class='columnlabel1'>วันที่เริ่มต้น&nbsp;:&nbsp;</td><td width="182" class='columnobject'><input name='date_from' type='text' class="inputs" id="date_from" value='<%=start_year%>' size="15" />
                                ...
                                <td width="150" class='columnlabel1'><script type='text/javascript'>Calendar.setup({inputField: 'date_from', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_1', singleClick: true, step: 1});</script>
                                    วันที่สิ้นสุด&nbsp;:&nbsp;</td>
                                <td width="267" class='columnobject'><input name='date_to' type='text' class="inputs" id="date_to" value='<%=end_year%>' size="15" />
