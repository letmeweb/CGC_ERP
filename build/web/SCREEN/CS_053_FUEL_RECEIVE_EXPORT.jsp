...
<html>
    ...
    <body onUnload="closepopup()">
        <form name="exportfile" method="post" action="../JSP/CS_053_MYSQL_EXPORT.jsp" >
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2">Export MySQL Data&nbsp;</td>
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td colspan='4'><b>กำหนดเงื่อนไข <span class="ftopcenter">Export MySQL Data</span></b></td>
                                </tr>
                                <!--<tr>
                                    <td width="158" class='columnlabel'>ชื่อข้อมูลที่&nbsp;Export</td><td colspan="3" class='columnobject'><input name='export_id' type='text' class="inputs" id="export_id" value='' size="20" />
