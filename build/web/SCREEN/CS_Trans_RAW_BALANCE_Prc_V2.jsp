...
<html>
    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <input type="hidden" name="report_code" value="RP_015_RAW_BALANCE_NEW">
            ...
            <%
                ...
                String sqlDelete = " DELETE FROM tmp_stock_4 ;"
                        + " ALTER SEQUENCE seq_tmp_stock_4 RESTART WITH 1; ";
                ...
                while (rec_wh_stock != null && (rec_wh_stock.next())) {
                    ...
                    SqlInsertSTK = "INSERT INTO tmp_stock_4(pgroup_id,product_id,ptype_id,pcat_id,wh_id,unit_name,doc_date,data_total,price_per_unit,data_transfer,doc_type,data_r,data_w) VALUES "
