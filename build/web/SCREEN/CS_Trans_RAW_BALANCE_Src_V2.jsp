        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> 
                    <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp; <b>รายงานยอดคงเหลือวัตถุดิบ (CS_Trans_RAW_BALANCE_Scr_V2)</b>
                </div>                

                <div class="panel-footer">

                    <form name ="report" action="CS_Trans_RAW_BALANCE_Prc_V2.jsp" target="_blank" method ="post">
