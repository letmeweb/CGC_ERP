    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd()
            {
                ...
                {
                    getSave_1(URLsend('doc_id,doc_type,doc_date,product_id,location_id,weight,wh_in,status_a,username', '../JSP/CS_116.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave_1(URLsend('doc_id,product_id,location_id,weight,wh_in,line_no,status_u,username', '../JSP/CS_116.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show", "doc_id", "../JSP/CS_Show116.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show116.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1500);
            ...
            function goDelete()
            {
                alertify.confirm("ต้องการลบข้อมูลหรือไม่ ?", function(e) {
                    if (e)
                    {
                        getSave_1(URLsend('doc_id,product_id,location_id,weight,wh_in,line_no,status_d,username', '../JSP/CS_116.jsp'));
                        opener.getId("doc_id").disabled = true;
                        showTable("show", "doc_id", "../JSP/CS_Show116.jsp?doc_id=");
                        setTimeout('showTable("show","doc_id","../JSP/CS_Show116.jsp?doc_id=")', 800);
                        setTimeout('window.close()', 1500);
