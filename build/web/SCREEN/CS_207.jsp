                            ...
                            <tr>
                                <td colspan='2' class='blankspace'>
                                    ...
                                    <div align="center">
                                        ...
                                        <a href="javascript:;" onClick="confirmDialogSave_1(URLsend('chkNull,runno,location_id,name_t,remark,username,location_id_ref,price_per_unit', '../JSP/CS_207.jsp'))"><img alt=""  src="../IMAGES/BTN_SAVE_90.png" class="imgtransparent" width="80" height="30" border="0"></a>
                                        <a href="javascript:;" onClick="confirmDialogDelete_1(URLsend('runno,location_id,name_t,remark,status_d,username', '../JSP/CS_207.jsp'))"><img alt=""  src="../IMAGES/BTN_DEL_90.png" class="imgtransparent" width="80" height="30" border="0"></a>
                                    </div>
                                    <br>
                                </td>
                            </tr>
