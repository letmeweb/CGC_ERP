...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goAdd(){
                ...
                {
                    getSave(URLsend('doc_id,wh_in,wh_out,doc_date,line_no,production_no,size,g_code,g_sum,ctc_i2,bag,weight,remark,status_a,username,bag_no,wh_weight,wh_id,product_id,weight_diff','../JSP/CS_301.jsp'));
            ...
            function goEdit()
            {
                ...
                if(ChkParameter(arrayChk))
                {
                    getSave(URLsend('doc_id,wh_in,wh_out,doc_date,line_no,production_no,size,g_code,g_sum,ctc_i2,bag,weight,remark,status_u,username,bag_no,wh_weight,wh_id,product_id,weight_diff','../JSP/CS_301.jsp'));
                    opener.getId("doc_id").disabled = true;
                    showTable("show","doc_id","../JSP/CS_Show301.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show301.jsp?doc_id=")',800);
                    setTimeout('window.close()', 1500);
            ...
            {                
                //getId(weight_diff).value = !isNaN(parseInt(getId(g_sum).value, 10) + parseInt(getId(wh_weight).value, 10) - parseInt(getId(weight).value, 10))?(parseInt(getId(g_sum).value, 10) + parseInt(getId(wh_weight).value, 10) - parseInt(getId(weight).value, 10)).toString():"0";
    ...
    <%!    UtiDatabase objuti = new UtiDatabase();
        ...
        String doc_id, wh_in, wh_out, doc_date, line_no,
                ...
                wh_weight, wh_id, product_id, create_by, weight_diff;
    %>
    <%
        doc_id = "";
        wh_in = "";
                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='size' type='text' class="inputs" id="size" value='<%=size%>' size='10' readonly/>	 <a href='#' onClick="openBrWindow('m_carbon_size', 30, 'Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>        	</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสยอดยกมา&nbsp;</td>
                                <td class="columnobject">
                                    <input name='g_code' type='text' class="inputs" id="g_code" value='<%=g_code%>' size='10' />	          	</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ยอดยกมา&nbsp;</td>
                                <td class="columnobject">
                                    <input name='g_sum' type='text' class="inputs" id="g_sum" value='<%=g_sum%>' size='10' onblur="IsNuber(this.value, this)"/>	          	</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">I2&nbsp;</td>
                                <td class="columnobject">
                                    <input name='ctc_i2' type='text' class="inputs" id="ctc_i2" value='<%=ctc_i2%>' size='10'  readonly/><a href='#' onclick="openBrWindow('m_iodine&textinput=ctc_i2', 0, 'Search_Detail.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">หน่วยบรรจุ*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='bag' type='text' class="inputs" id="bag" value='<%=bag%>' size='10' onkeyup="IsNumber2(this.value, this)"/>	          	</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="wh_weight" type='text' class="inputs" id="wh_weight" value="<%=wh_weight%>" size="10" onBlur="Weight_diff('g_sum','weight','wh_weight','weight_diff')" onkeyup="IsNuber(this.value, this)">
                                    ยอดผลต่าง
                                    <input name="weight_diff" type='text' class="inputs" id="weight_diff" size="10" value="<%=weight_diff%>" readonly></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสคลัง*</td>
                                <td class="columnobject"><input name="wh_id" type='text' class="inputs" id="wh_id" size="10" value ="<%=wh_id%>" readonly>&nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('mwarehouse', 301, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type='text' class="inputs" name="wh_id_desc" id="wh_id_desc"></td>
                            </tr>
                            <tr>
                                <!--<td class="columnlabel">สูญเสีย&nbsp;</td>
                        <td class="columnobject">
                                <input name='lost' type='text' class="inputs" id="lost" value='' size='10' />
                        </td>-->
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสสินค้า*</td>
                                <td class="columnobject"><input name="product_id" type='text' class="inputs" id="product_id" value="<%=product_id%>" size="10" readonly>&nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('Vproduct', 301, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type='text' class="inputs" name="product_id_desc" id="product_id_desc"></td>
                            </tr>
                            <tr>
