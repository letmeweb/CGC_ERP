            ...
            function CreateNewRow()
            {
                ...
                if (intLine === 0) {
                    for (var i = 1; i <= 20; i++) {
                        ...
                        newCell.setAttribute("class", "forborder");
                        newCell.setAttribute("align", "center");
                        newCell.innerHTML = "<td   style=\"width: 100px;\" ><INPUT    TYPE=\"text\" SIZE=\"15\" name=\"P_job\" ID=\"P_job_id_" + intLine + "\" VALUE=\"\"  onclick=\"openBrWindow(\'vd_job_order_header&textinput=P_job_id_" + intLine + "\', 0, \'Search_Detail_Desc2.jsp\')\" readonly></td>";
                        newCell = newRow.insertCell(3);
                        newCell.setAttribute("width", "3%");
                        newCell.setAttribute("class", "forborder");
                        newCell.setAttribute("align", "center");
                        newCell.innerHTML = "<td><INPUT   TYPE=\"text\" SIZE=\"3\" name=\"P_location_id\" ID=\"P_location_id_" + intLine + "\" VALUE=\"\"  onclick=\"openBrWindow(\'mproduct_cat&textinput=P_location_id_" + intLine + "\', 0, \'Search_Detail_Desc.jsp\')\" readonly></td>";
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2">บันทึกรายการ สีถ่าน-เติมเตา (วัตถุดิบ-ผลิต)(CS_D_carbon_friction_burn_header)&nbsp;</td>
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td width="150" class="columnlabel">วันที่นำส่ง*&nbsp;</td>
                                ...
                                <tr>
                                    <td width="150" class="columnlabel">ประเภทงาน&nbsp;</td>
                                    <td width="607" class="columnobject">                                    
                                        ...
                                        <div style="width:100%; height: 450px; overflow: auto;" id="show">
                                            <table style="width:100%;"  align="left" border="0" cellpadding="0" cellspacing="1" class="inner"  name = "tbExp" id = "tbExp">
                                                ...
                                                <tr align='center'>
                                                    ...
                                                    <td class="row3" >กองที่</td>
                                                    <td class="row3" >โกดัง/โรงสี</td>
                                                    <td class="row3" >% ความชื้น</td>
                                                    <td class="row3" >นน.ถ่านเข้า</td>
                                                    <td class="row3" >นน.ถ่านสี</td>
                                                    <td class="row3">นน.ฝุ่น</td>
                                                    <td class="row3">นน.เหล็ก</td>
                                                    <td class="row3">รวม</td>
                                                    <td class="row3">นน.ถ่านถุงใหญ่</td>
                                                </tr>                                               
                                ...
                                <tr>
                                    <td class="columnlabel">ผู้นำส่ง&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel">ผู้บันทึกผลวิเคราะห์ฯ&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel">ผู้ตรวจรับ&nbsp;</td>
