        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>สรุปเปอร์เซ็นต์สูญเสียวัตถุดิบแต่ละกอง (CS_Trans_C_RAW_Lost_Scr_V1)</b>
                </div>                

                <div class="panel-footer">

                    <!--form name ="report" action="CS_Trans_C_RAW_Lost_Prc_V1.jsp" target="_blank" method ="post"-->
                    <form name ="report" action="CS_Trans_C_RAW_Lost_Prc_V1_New.jsp" target="_blank" method ="post">
                        <input type="hidden" name="chkNull" id="chkNull" value="date_f,date_t">
                        <input type="hidden" name="date_from" value="">
                        <input type="hidden" name="date_to" value="">          
                        <table  cellpadding="0"  cellspacing="0">                        
                            <tr>
                                <!--td class=""><b>กลุ่มวัตถุดิบ :</b></td-->
                                <td class='columnobject'><div align="right"><b>กลุ่มวัตถุดิบ&nbsp;:</b>&nbsp;</div></td>      
                                <td class="columnobject"><input name="pgroup_id" type='text' class="inputs" id="pgroup_id" value="RAW" size="10" readonly>                                        
                            </tr>                                  

                            <tr>
                                <!--td class=""><b>ประเภทวัตถุดิบ :</b></td-->
                                <td class='columnobject'><div align="right"><b>ประเภทวัตถุดิบ&nbsp;:</b>&nbsp;</div></td>
                                <td class="columnobject"><input name="ptype_id" type='text' class="inputs" id="ptype_id" value="RAW" size="10" readonly>                                        
                                    <input type="text" class="inputs" name="name_t_pgroup" id="name_t_pgroup" value="ถ่านวัตถุดิบ" size="30"></td>
                            </tr>   

                            <tr>
                                <!--td class="columnlabel">รหัสวัตถุดิบ</td-->
                                <!--td class="columnobject"><input name="product_id" type='hidden' class="inputs" id="product_id" value="" size="20" >&nbsp;&nbsp;<a href='#' onClick="openBrWindow('Vproduct', 301, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;-->
                                <td class="columnobject"><input name="product_id" type='hidden' class="inputs" id="product_id" value="" size="20" >
