...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function summit_data() {
                ...
                getsaveApprove2(URLsend(IDsend, "../JSP/CS_IMPORT_FUEL.jsp"), "report");
            }
        </script>        
    ...
    <body onload="addDate();">
        ...
        <input type="hidden" id="process_for" name="process_for" value="FUEL">            
        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-save" style="color:white"></span>&nbsp;
                    <b>ดึงข้อมูลชั่งน้ำหนักเชื้อเพลิง (CS_IMPORT_FUEL)</b>
                </div>                
                    ...
                    <table  cellpadding="0" cellspacing="0" >
                        ...
                        <tr>
                            <td class='columnobject'><b>วันที่เริ่มต้น : &nbsp;</b></td><td class='columnobject'><input name='doc_date_from' type='text' class="inputs" id="doc_date_from" value="" readonly/>
                                ...
                                &nbsp;<a id='date_2'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.png' border='0' align='absmiddle' data-toggle="tooltip" title="ถึงวันที่"></a><script type='text/javascript'>Calendar.setup({inputField: 'doc_date_to', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_2', singleClick: true, step: 1});</script></td>
                        </tr>
                        <tr>
                            <td colspan='2'><b>&nbsp;</b></td>
                        </tr>
