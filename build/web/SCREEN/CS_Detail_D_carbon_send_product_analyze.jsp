...
<html>
        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    ...
                    getSave_1(URLsend('doc_id,line_no,doc_date,status_a,job_id,product_id,size_name,iodine,machine_id,pallet,product_no,bag_quatity,bag_weight,weight,wh_id,location_id,wh_product_id,fraction,job_type,username,emp_id,doc_type,param_header_id', '../JSP/CS_Detail_D_carbon_send_product_analyze.jsp'));
                    //opener.showdetail();
                    showTable("show", "doc_id", "../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=");', 800);
            ...
            function goEdit()
            {
                ...
                if (ChkParameter_1(arrayChk))
                {
                    //alert("EDIT");
                    //getSave_1(URLsend('doc_id,line_no,job_id,product_id,size_name,iodine,machine_id,pallet,product_no,bag_quatity,bag_weight,weight,status_a,I_status,username', '../JSP/CS_Detail_D_carbon_send_product.jsp'));
                    getSave_1(URLsend('username,lab_emp_id,doc_id,doc_date,line_no,status_u,job_id,product_id,size_name,iodine,machine_id,pallet,product_no,bag_quatity,bag_weight,weight,wh_id,location_id,wh_product_id,fraction,h2o,butane,iod,psd_1,psd_2,psd_3,psd_4,psd_5,psd_6,psd_7,psd_8,psd_9,psd_10,psd_11,psd_12,psd_13,psd_14,psd_15,valuepass,grade,remark,param_header_id', '../JSP/CS_Detail_D_carbon_send_product_analyze.jsp'));
                    showTable("show", "doc_id", "../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_ShowD_carbon_send_product_analyze.jsp?doc_id=");', 800);
                    setTimeout('window.close()', 700);
                }
    ...
    <body onLoad="passvaluechk()">
        ...
        <%! ThaiUtil en = new ThaiUtil();
            D_carbon_send_product_detail_analyzeDAO objDAO = new D_carbon_send_product_detail_analyzeDAO();
        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;<b>ข้อมูลการนำส่งสินค้า</b></div>
                <div class="panel-footer">        
                    <table  cellpadding="0"  cellspacing="0" align="center">                                    
                        ...
                        <tr>
                            <td class="">ชนิดถ่าน*&nbsp;</td>
                            <td class="columnobject"><input type='text' class="inputs" name="product_id" id="product_id" value="<%=product_id%>" readonly/></td>
                            <!--/tr>
                            <tr-->
                            <td class="">ประเภท&nbsp;</td>
                            <td class="columnobject"><input type='text' class="inputs" name="job_type" id="job_type" value="<%=job_type%>" /></td>
                        </tr>                            
                        <tr>
                            <td class="">ขนาด&nbsp;</td>
                        ...
                        <tr>
                            <td class="">น้ำหนักรวม (กิโลกรัม)&nbsp;</td>
                        ...
                        <tr>
                            <td class="">รหัสสินค้า (คลังสินค้า)&nbsp;</td>
                            <td class="columnobject"><input type='text' class="inputs" name="wh_product_id" id="wh_product_id" value="<%=wh_product_id%>" onclick="openBrWindow('vmproduct&textinput=wh_product_id', 0, 'Search_Detail_Desc.jsp')" readonly/>
                                <!--input type='text' class="inputs" name='name_t_product' id="name_t_product" size='70' value='<%=name_t_product%>' /-->
                            </td>
                            <!--/tr>                             
                            <tr-->
                            <td class="">จัดเก็บโกดัง/คลัง (คลังสินค้า)&nbsp;</td>
                        ...
                        <tr>
                            <td class="">จัดเก็บกองที่ (คลังสินค้า)&nbsp;</td>
        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;<b>ข้อมูลผลการวิเคราะห์</b></div>
                <div class="panel-footer">                                       

                    <table style="width:800px">
                        <tr>
                            <td class=""><B>Parameter</B></td>                                         
                            <td class="columnobject"><input type='text' class="inputs" name="param_header_id" id="param_header_id" size="30" value="<%=param_header_id%>" data-toggle="tooltip" title="เลือก Parameter จากใบแจ้งการผลิต" onclick="openBrWindow('vd_header_analyze', 0, 'Search_Config2.jsp')" readonly/>
                            </td>
                            <td>
                                <a href='#' onclick="openBrWindow('vd_header_analyze', 0, 'Search_Config2.jsp')" data-toggle="tooltip" title="เลือก Parameter จากใบแจ้งการผลิต" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='25' height='25' border='0' align='middle' ></a>                                       
                            </td>
                        </tr>
                        <tr>
                            <td class=""><B>LAB</B></td>         
                            <td class=""><B>ผลการวิเคราะห์&nbsp;</B></td>                         
                            <td class=""><B></B></td>                                               
                            <td class=""><B></B></td>                                               
                            <td class=""><B></B></td>                                                               
                            <td class=""><B>PSD1</B></td>         
                            <td class=""><B>PSD2</B></td>       
                            <td class=""><B>PSD3</B></td>       
                            <td class=""><B>PSD4</B></td>       
                            <td class=""><B>PSD5</B></td>       
                            <td class=""><B>PSD6</B></td>       
                            <td class=""><B>PSD7</B></td>       
                            <td class=""><B>PSD8</B></td>       
                            <!--td class=""><B>PSD9</B></td>       
                            <td class=""><B>PSD10</B></td-->                            
                        </tr> 
                        <tr>
                            ...
                            <td class="columnobject"><input type='text' class="inputs" name="psd_1_header" id="psd_1_header" size="4" value="<%=psd_1_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_2_header" id="psd_2_header" size="4" value="<%=psd_2_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_3_header" id="psd_3_header" size="4" value="<%=psd_3_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_4_header" id="psd_4_header" size="4" value="<%=psd_4_header%>" readonly /></td>   
                            <td class="columnobject"><input type='text' class="inputs" name="psd_5_header" id="psd_5_header" size="4" value="<%=psd_5_header%>" readonly /></td>      
                            <td class="columnobject"><input type='text' class="inputs" name="psd_6_header" id="psd_6_header" size="4" value="<%=psd_6_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_7_header" id="psd_7_header" size="4" value="<%=psd_7_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_8_header" id="psd_8_header" size="4" value="<%=psd_8_header%>" readonly /></td>
                            <!--td class="columnobject"><input type='text' class="inputs" name="psd_9_header" id="psd_9_header" size="4" value="<%=psd_9_header%>" readonly /></td>   
                            <td class="columnobject"><input type='text' class="inputs" name="psd_10_header" id="psd_10_header" size="4" value="<%=psd_10_header%>" readonly /></td-->
                        </tr>               
                        <tr>
                            <td class="columnobject"></td>
                            <td class="columnobject"></td>                
                        ...
                        <tr>
                            ...
                            <td class=""><B>PSD9</B></td>       
                            <td class=""><B>PSD10</B></td>                   
                            <td class=""><B>PSD11</B></td>                   
                            <td class=""><B>PSD12</B></td>       
                            <td class=""><B>PSD13</B></td>       
                            <td class=""><B>PSD14</B></td>       
                            <td class=""><B>PSD15</B></td>                
                        </tr>
                        <tr>
                            <td class="columnobject"></td>
                            <td class="columnobject"></td>
                            ...
                            <td class="columnobject"><input type='text' class="inputs" name="psd_9_header" id="psd_9_header" size="4" value="<%=psd_9_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_10_header" id="psd_10_header" size="4" value="<%=psd_10_header%>" readonly /></td>            
                            <td class="columnobject"><input type='text' class="inputs" name="psd_11_header" id="psd_11_header" size="4" value="<%=psd_11_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_12_header" id="psd_12_header" size="4" value="<%=psd_12_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_13_header" id="psd_13_header" size="4" value="<%=psd_13_header%>" readonly /></td>
                            <td class="columnobject"><input type='text' class="inputs" name="psd_14_header" id="psd_14_header" size="4" value="<%=psd_14_header%>" readonly /></td>   
                            <td class="columnobject"><input type='text' class="inputs" name="psd_15_header" id="psd_15_header" size="4" value="<%=psd_15_header%>" readonly /></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="columnobject"><input type="radio" name="status1" id="pass" value="Y" onClick="javascript:getId('valuepass').value = this.value;">
                                ...
                                <!--td class="columnobject"><input name="wh_iodine" type="hidden" id="wh_iodine" size="20" value="<%=wh_iodine%>"></td-->
                            </td>
                        </tr>


                        <td class=""><b>หมายเหตุ : </b>&nbsp;</td>
                    ...
                    <table>    
                        <tr>
                            <td class=""><b>ผู้บันทึกผลวิเคราะห์ : </b>&nbsp;
                            <input name="lab_emp_id" type='text' class="inputs" id="lab_emp_id" value ="<%=lab_emp_id%>" size="15" readonly="true">
                    ...
                    %>
                    <button type="button" class="btn btn-primary btn-block" data-toggle="tooltip" title="กดปุ่มเพื่อบันทึกข้อมูล" name="button1" value="บันทึกข้อมูล" onClick="javascript:goAdd();"/><b>บันทึกข้อมูล</b></button>
                    <%} else {
                    %>
                    <button type="button" class="btn btn-primary btn-block" data-toggle="tooltip" title="กดปุ่มเพื่อบันทึกข้อมูล" name="button1" value="บันทึกข้อมูล" onClick="javascript:goEdit();"/><b>บันทึกข้อมูล</b></button>
                    <%}
                    %>      
                    <table class="table">                        
                    </table>
                    <button type="button" class="btn btn-warning btn-block" data-toggle="tooltip" title="กดปุ่มเพื่อออกจากหน้าจอนี้" name="button2" value="ยกเลิก" onClick="javascript:goBack();"/><b>ปิด</b></button>
                </div> 
            </div>
        </div>        
    </body>
