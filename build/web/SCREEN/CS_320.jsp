            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2"><DIV id="u4_rtf">
                            <DIV id="u4_rtf2">
                                <DIV id="u9_rtf">
                                    <DIV id="u4_rtf3">ใบแจ้งคืนถ่านกัมมันต์ที่เหลือจากการผลิตเข้าคลังสินค้า(CS_103)</DIV>
                                </DIV>
                            </DIV>
                        </DIV></td>
                ...
                <tr >
                    ...
                    <td  colspan="2" class="fcentercenter"><div align="center">
                            <table width="94%"  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td width="156" align=""
                                        class="columnlabel"><b>เลขที่เอกสาร*</b>&nbsp;</td>
                                            ...
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    ...
                                                    <td colspan="9" class="btn_multi">
                                                        <input type='button' name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,status_a,username','CS_108.jsp'));"/>
                                ...
                                <tr>
                                    <td colspan='2' class='blankspace'>
                                        <br>
                                        <div align="center">
                                            <a href="javascript:;" onClick="cancle()"><img alt="ล้างหน้าจอ"  src="../IMAGES/BTN_CANCEL_90.png" width="80" height="30" border="0"></a>
                                            <a href="javascript:;" onClick="AddHeader()"><img alt="บันทึก/แก้ไข"  src="../IMAGES/BTN_SAVE_90.png" width="80" height="30" border="0"></a>
                                            <a href="javascript:;" onClick="Delete()"><img alt="ลบ"  src="../IMAGES/BTN_DEL_90.png" width="80" height="30" border="0"></a>                                                       
