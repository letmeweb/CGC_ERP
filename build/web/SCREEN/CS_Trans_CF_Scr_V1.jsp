        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>รายงานความเคลื่อนไหวถ่านวัตถุดิบ (ถ่านสี-ถุงใหญ่) (CS_Trans_CF_Scr_V1)</b>
                </div>                
                    ...
                    <form name ="report" action="CS_Trans_CF_Prc_V1.jsp" target="_blank" method ="post">
                        ...
                        <table  cellpadding="0"  cellspacing="0">                        
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="ptype_id" type='text' class="inputs" id="ptype_id" value="CF" size="10" readonly>                                        
                                    <input type="text" class="inputs" name="name_t_pgroup" id="name_t_pgroup" value="ถ่านวัตถุดิบที่สีแล้ว" size="30"></td>
                            </tr>   
