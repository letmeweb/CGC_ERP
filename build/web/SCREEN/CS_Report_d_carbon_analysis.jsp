    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function send_print_all(search_date, report_code) {
                ...
                if (report_code == "RP_092_BY_DASTE") {
                    getId("doc_no").value = getId('doc_no_v').value;
                    getId("doc_eff_date").value = getId('doc_eff_date_v').value;
                } else {
                    getId("doc_no").value = getId('doc_no_u').value;
    ...
    <body>
        <form id="report" name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <%
                ...
                objs_p = h_p.selectheaderscreen_process(objs_p, "CS_Report_d_carbon_analysis");
                objs_v = h_p.selectheaderscreen_process(objs_v, "CS_Report_d_carbon_analysis");
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    <div class="panel-heading"> <span class="glyphicon glyphicon-search" style="color:white"></span>&nbsp;
                        <b>รายงานการวิเคราะห์ถ่านออกจากเตา (CS_Report_d_carbon_analysis)</b>
                    </div>                
                    ...
                    <div class="panel-footer">               
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <!--tr>
                                ...
                                <input type='button' class="cgcButton_10" name='print_all' onClick="send_print_all(this.form.search_date.value, 'RP_092_BY_DATE');" value='พิมพ์ผลวิเคราะห์ทั้งหมด'/>                                                                        </tr>                                    
                            <tr-->
                            <tr>
