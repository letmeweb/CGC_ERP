        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-log-in" style="color:white"></span>&nbsp;
                    <b>ข้อมูลสรุปการรับถ่านวัตถุดิบ (CS_053_Rawmat_Summary_Month_EXPORT)</b>
                </div>                

                <div class="panel-footer">        

                    <form name="exportfile" method="post" action="../JSP/CS_053_Rawmat_Summary_Month_EXPORT.jsp" >
                        <% UtiDatabase objuti = new UtiDatabase();
                            String current_date, start_year ,end_year;
                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td colspan='4'><b>กำหนดเงื่อนไข <span class="ftopcenter">Export การรับถ่านวัตถุดิบ</span></b></td>
                            </tr>

                            <tr>
                                <td class='columnlabel1'>วันที่เอกสารเริ่มต้น&nbsp;:&nbsp;</td><td width="182" class='columnobject'><input name='date_from' class='inputs' type='text' class="inputs" id="date_from" value='<%=start_year%>' size="15" readonly="true"/>
                                ...
                                <td width="267" class='columnobject'><input name='date_to' class='inputs' type='text' class="inputs" id="date_to" value='<%=end_year%>' size="15" readonly="true"/>
                            ...
                            <input name='cred_code' class='inputs' type='hidden' class="inputs" id="cred_code">
                            <input name='cred_name' class='inputs' type='hidden' class="inputs" id="cred_name">
