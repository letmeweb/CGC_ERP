    ...
    <head>
        ...
        <script type="text/javascript">
            function goAdd() {
                ...
                {
                    getSave_1(URLsend('doc_id,wh_id,product_id,place_prd,palate_no,size,i2,bag,weight,remark,status_a,username,product_no,fraction_bag,doc_type,pack_repacking_status', '../JSP/CS_041_1.jsp'));
            ...
            function goEdit()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    getSave_1(URLsend('doc_id,line_no,wh_id,product_id,place_prd,palate_no,size,i2,bag,weight,remark,status_u,username,product_no,fraction_bag,doc_type,pack_repacking_status', '../JSP/CS_041_1.jsp'));
                    showTable("show", "doc_id", "../JSP/CS_Show041_1.jsp?doc_id=");
                    setTimeout('showTable("show","doc_id","../JSP/CS_Show041_1.jsp?doc_id=")', 800);
                    setTimeout('window.close()', 1000);
                }
