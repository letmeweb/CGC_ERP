...
<html>
    ...
    <body>
        ...
        <h2><center>Return Document คืนเอกสารการนำส่งถ่านเข้าคลังสินค้า</center></h2>
        ...
        // Note: this is set up to look in the same directory as the jsp file.
            String fileName = "data_carbon_send_product.txt";
        ...
        // 'application' is a freebie from the parent servlet.
                ...
                while (line != null) {
                    ...
                    out.println("update d_carbon_send_product_header set complete_flag = 'N' , wh_leader_confirm = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
                    out.println("update d_carbon_send_product_detail set complete_flag = 'N' where doc_id = '" + line + "' ;");
                    out.println("<BR>");
        %>
        <%
                    line = br.readLine();
