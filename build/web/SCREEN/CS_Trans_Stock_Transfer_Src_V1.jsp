        ...
        <div class="container">        
            <div class="panel panel-primary">
                <div class="panel-heading"> <span class="glyphicon glyphicon-list" style="color:white"></span>&nbsp;
                    <b>รายงานยอดคงเหลือสินค้าเพื่อยกยอด (CS_Trans_Stock_Transfer_Src_V1)</b>
                </div>                

                <div class="panel-footer">

                    <form name ="report" action="CS_Trans_Stock_Transfer_Prc_V1.jsp" target="_blank" method ="post">
                        ...
                        <table  cellpadding="0"  cellspacing="0">                                                                                    
                            ...
                            <tr>
                                ...
                                <td class='columnobject'><input name="date_t" type='text' class="inputs" id="date_t" value="<%=end_year%>" readonly/>
