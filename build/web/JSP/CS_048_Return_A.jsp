...
<%
            ...
            String id = "";
            sql_main = "select * from mstd_cost_main where process_id = '" + process_id + "' and delete_flag <> 'Y'  order by runno";
            try {
            ...
            for (int i = 0; i < cnt; i++) {
                ...
                if (process_id.equals("PR_022")) {
                    ...
                    tStockBean.setProcess_id(process_id);
                    tStockBean.setLocation_id(list[2]);
                    tStockBean.setProduct_id(list[1]);
                    tStockBean.setWeight(list[4]);
                    tStockBean.setWh_in(list[3]);
                    ...
                    if (whBean != null) {
                        ...
                        whData.setWarehouse_id(list[3]);
                        whData.setLocation_id(list[2]);
                        ...
                        double price_ = Double.parseDouble(whBean.getWh_value()) + Double.parseDouble(list[5]);
                        ...
                        whDAO.update(whData);
                            ...
                            whDataTotal = whData;
                            double price_T = Double.parseDouble(whBeanTotal.getWh_value()) + Double.parseDouble(list[5]);
                        ...
                        tStockDAO.insertDetail(tStockBean,"wh_in");
                    } else {
                        T_WareHouseBean whData = new T_WareHouseBean();
                        T_WareHouseBean whDataTotal = new T_WareHouseBean();
                        whData.setWarehouse_id(list[3]);
                        whData.setLocation_id(list[2]);
                        whData.setProduct_id(list[1]);
                        whData.setWeight(list[4]);
                        double quant = Double.parseDouble(list[4]);
                        double price_ = Double.parseDouble(list[5]);
                        double total = new CostCal().calCostWh_Price(price_, quant);
                        whData.setPrice(df.format(total) + "");
                        whData.setWh_value(list[5]);
                    ...
                    rawmat.UpCompeteFlag(tStockBean.getDoc_no());
                } else {

                    DataBeanMPROCESS mProcess = new DataBeanMPROCESS();
                    MPROCESSDAO proDAO = new MPROCESSDAO();
                    FlagDAO flagDAO = new FlagDAO();
                    mProcess = proDAO.selectData(process_id);

                    //******************* transtock - *****************
                     System.out.println("Start");
                    tStockBean.setDoc_no(list[0]);
                    tStockBean.setProcess_id(process_id);
                    tStockBean.setLocation_id(list[5]); //*** get Location_out form CS_048
                    tStockBean.setProduct_id(list[1]);
                    tStockBean.setWeight(list[4]);
                    ...
                    System.out.println("Start");
                    String price_t = "1";
                    String price_total = "1";
                    if (whBean != null) {
                        T_WareHouseBean whData = new T_WareHouseBean();
                        T_WareHouseBean whDataTotal = new T_WareHouseBean();
                        whData.setWarehouse_id(mProcess.getWh_bg());
                        whData.setLocation_id(list[5]); //*** get Location_out form CS_048
                        whData.setProduct_id(list[1]);
                        double quant = Double.parseDouble(whBean.getWeight()) - Double.parseDouble(list[4]);
                        whData.setWeight(quant + "");
                    ...
                    if (whBean != null) {
                        ...
                        whData.setLocation_id(list[2]); //*** get Location_in form CS_048
                        whData.setProduct_id(list[1]);
                        double quant = Double.parseDouble(whBean.getWeight()) + Double.parseDouble(list[4]);
                        whData.setWeight(quant + "");
                    ...
                    while (rs.next()) {
                        for (int i = 0; i < cnt; i++) {
                            ...
                            if (type.equals("N")) {
                                ...
                                if (process_id.equals("PR_022")) {
                                    String total_price = list[5];
                                    double price = Double.parseDouble(total_price);
                                    cost = price;
                                    costBean.setCost_value(cost + "");
                                }else{
                                    String total_price = price_out;
