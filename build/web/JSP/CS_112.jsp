...
<%@page import="com.cgc.DB.D_qc_report_headerDAO"%>
<%@page import="com.cgc.bean.DataBeanD_qc_report_header"%>
...
<%!    ThaiUtil en = new ThaiUtil();
    DataBeanD_qc_report_header objdb = new DataBeanD_qc_report_header();
    D_qc_report_headerDAO objex = new D_qc_report_headerDAO();
...
<%
            ...
            if (request.getParameter("status_d") == null) {
                statusnum = uti.numRowdatabase("Select Count(doc_id) As num from  d_qc_report_header where doc_id = '" + en.EncodeTexttoTIS(request.getParameter("doc_id").trim()) + "' and delete_flag <> 'Y' and complete_flag <> 'Y'");
                if (statusnum == 0) {
                    statusck = 1;
                } else if (statusnum == 1) {
                    statusck = 2;
            ...
            objdb.setJob_no(request.getParameter("job_no"));
            objdb.setStuffing_date(request.getParameter("doc_date"));
