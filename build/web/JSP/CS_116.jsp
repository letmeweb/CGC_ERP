...
<%
    ...
    if (request.getParameter("doc_type") != null) {
        objdb.setDoc_type(request.getParameter("doc_type").trim());
    }    
    if (request.getParameter("doc_date") != null) {
        objdb.setDoc_date(request.getParameter("doc_date").trim());
    }        
    ...
    switch (statusck) {
        ...
        case 3:
            ...
            objex.Delete_line_no(request.getParameter("line_no"), objdb, "d_adjust_product_detail");
