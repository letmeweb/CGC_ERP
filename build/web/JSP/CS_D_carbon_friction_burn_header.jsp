...
<%@page import="com.cgc.bean.DataBeanCS_D_carbon_friction_burn_detail"%>
...
<%
    ...
    if (request.getParameter("wh_leader_confirm").equals("Y") && (request.getParameter("product_confirm").equals("N")||request.getParameter("quality_confirm").equals("N")||request.getParameter("wh_emp_confirm").equals("N"))) {
