    ...
    <body>
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            <%
                ...
                objr_p = r_p.Fn_Report(objr_p, "S516");
                path = objr_p.getPath();
            ...
            <input type="hidden" id="sub_menu_id" name="sub_menu_id"  value="<%=sub_menu_id%>">
                ...
                <div class="container">
                    <div class="panel panel-primary">
                        <div class="panel-heading"> <span class="glyphicon glyphicon-tasks"></span>&nbsp;
                            <b>รับถ่านออกจากเตาเขาคลังสินค้า (CS_300)</b>
                        </div>                        
                                ...
                                <table   cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="607" class="columnobject">
                                            ...
                                            &nbsp;
                                            <a href='#' onClick="openBrWindow('vd_carbon_burn_out_header_wh&stadment=and+complete_flag+<>+\'Y\'+and+doc_type=\'N\'', 300, 'Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                            <a href='#' onClick="openBrWindow('vd_carbon_burn_out_header_wh&stadment=and+complete_flag+<>+\'Y\'+and+doc_type=\'Y\'', 300, 'Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                            วันที่เอกสาร*&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><select class='select_cgc' name='shift' id="shift" disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            &nbsp;&nbsp;
                                            วัตถุดิบ&nbsp;<select class='select_cgc' name="product_id" id="product_id" disabled>
                                                ...
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td colspan="8" class="btn_multi">
                                                            <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="javascript:goAddChild(URLsend('doc_id,wh_in,wh_out,doc_date,total_weight,lost_weight,status_a,username', 'CS_301.jsp'));"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="row3" width="8%">กอง</td>                                                    
                                                        <td class="row3" width="15%">รหัสสินค้า</td>
                                                        <td class="row3" width="8%">ยอดยกไป<br></td>
                                                    </tr>
                                                </table>
                                            </div>
