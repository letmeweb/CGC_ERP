                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <!--tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        <a href='javascript:;' onClick="openBrWindow('vd_saleorderproduct_detail&stadment=and+(doc_type+<>+\'Y\'+or+doc_type+is+null)', 32, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' >
                                        </a>&nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject"><input name='mark_sign' type='hidden' id="mark_sign" value='N'/>
                                        ...
                                        <b>ตีตรา</b><input type='text' class="inputs" id="mark_sign_desc" name="mark_sign_desc" value="" disabled>

                                    </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1"><b>หมายเหตุ</b>&nbsp;</td>
                                    <td class="columnobject"><textarea class='text_inputs' name='remark' cols='100' rows='5' id="remark"></textarea></td>
                                </tr>
                                <tr>
                                    <td class="columnlabel1">&nbsp;</td>
                                    <td class="columnobject">
