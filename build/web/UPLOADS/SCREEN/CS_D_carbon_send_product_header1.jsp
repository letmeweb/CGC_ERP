...
<%@page import="java.io.*"%>
<html>
    <%!    String path, lookup, doc_eff_date, doc_no, doc_id;
    %>
    <head>
        ...
        <form name="report" method="post" action="../JSP/CS_REPORT.jsp" target="_blank">
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2">บันทึกรายการนำส่งสินค้าเข้าคลังสินค้า(งานบด-ร่อน)(CS_D_carbon_send_product_header)&nbsp;</td>
                                        ...
                                        <table width="200%" align="left" border="0" cellpadding="0" cellspacing="1" class="inner">
                                            <tr>
                                                ...
                                                <td colspan="4" class="btn_multi">
                                                    <input type='button' align="left" class="cgcButton_4" name='bt_insert' id="bt_insert" value='  เพิ่ม  ' onClick="getId('status_cancle').value == '1' ? goAddChild(URLsend('A_doc_id,A_doc_date,dept_id,I_status,A_username,A_doc_type', 'CS_Detail_D_carbon_send_product.jsp')) : CreateNewRow_Test();"/>
