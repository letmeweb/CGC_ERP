...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function get_search() {
                showTableNonPopup("show1", "search_date", "../JSP/CS_Show_Report_d_carbon_carbon_send_qc.jsp?select_case=1&search_date=");
            ...
            <div class="container">        
                <div class="panel panel-primary">
                    <div class="panel-heading"> <span class="glyphicon glyphicon-search" style="color:white"></span>&nbsp;
                        <b>ค้นหาใบนำส่งสินค้า / ผลวิเคราะห์ฯ (CS_Report_d_carbon_send_product_qc)</b>
                    </div>                
                                    ...
                                    <td colspan="2" align="center">
                                        <div width="100%">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                <tr>
                                                    <td class="headergrid" colspan="14">ใบนำส่งสินค้า</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="row5" width="5%">ประเภทงาน</td>
                                                    <td class="row5" width="5%">ขนาดถ่าน</td>
                                                    <td class="row5" width="5%">ใบแจ้งผลิต</td>
                                                    <td class="row5" width="5%">รหัสผลิต</td>                                                        
                                                </tr>
                                            </table>
                                        </div>
