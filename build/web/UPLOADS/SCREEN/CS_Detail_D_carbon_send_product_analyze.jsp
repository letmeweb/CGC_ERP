        ...
        <script type="text/javascript">
            ...
            function goAdd()
            {
                ...
                if (ChkParameter(arrayChk))
                {
                    ...
                    getSave(URLsend('doc_id,line_no,doc_date,status_a,job_id,product_id,size_name,iodine,machine_id,pallet,product_no,bag_quatity,bag_weight,weight,wh_id,location_id,wh_product_id,fraction,job_type,username,emp_id,doc_type,param_header_id', '../JSP/CS_Detail_D_carbon_send_product_analyze.jsp'));
                    //opener.showdetail();
