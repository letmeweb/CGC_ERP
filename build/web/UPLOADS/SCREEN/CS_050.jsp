    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function showTablePage(){
                getId("show").innerHTML = "";
                showTableNonPopup('show', 'doc_id', '../JSP/CS_050_List.jsp?doc_id=');
            }
        ...
        <div>
            <table  cellpadding="0"  cellspacing="0">
                <tr >
                    ...
                    <td  class="ftopcenter" colspan="2">อนุมัติการเบิกถ่านกัมมันต์ไปใช้ในการผลิต (คลังสินค้า)&nbsp;</td>
                        ...
                        <div align="center">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                  ...
                                  &nbsp;<a href='javascript:;' onClick="javascript:openBrWindow('vd_carbon_withdraw_detail',50,'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.png' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div width="100%">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="row5" width="5%">เครื่องผลิต&nbsp;</td>
                                                    <td class="row5" width="14%">น้ำหนักแจ้งเบิก&nbsp;</td>
